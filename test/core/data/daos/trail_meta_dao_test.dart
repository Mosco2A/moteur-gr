...
void main() {
  ...
  group('TrailMetaDao', () {
    test('insertOrReplace puis getById retourne le bon sentier', () async {
      await dao.insertOrReplace(makeMeta(id: 'tr1', code: 'gr20'));

      final result = await dao.getById('tr1');
      expect(result, isNotNull);
      expect(result!.code, 'gr20');
    ...
    test('insertOrReplace met a jour un sentier existant', () async {
      await dao.insertOrReplace(makeMeta(id: 'tr1', code: 'gr20', dataVersion: 1));
      await dao.insertOrReplace(makeMeta(id: 'tr1', code: 'gr20', dataVersion: 2));
    ...
    test('lastSync nullable fonctionne', () async {
      await dao.insertOrReplace(
        makeMeta(id: 'tr1', code: 'gr20', lastSync: '2026-05-26T12:00:00Z'),
      );
