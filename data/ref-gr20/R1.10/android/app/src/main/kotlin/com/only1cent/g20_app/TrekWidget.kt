...
/// Widget Android Home Screen pour la progression trek GR20.
///
...
class TrekWidget : AppWidgetProvider() {
    ...
    private fun updateAppWidget(
        ...
        val trailName = prefs.getString("${PREFIX}trail_name", "GR20") ?: "GR20"
        ...
        val totalStages = prefs.getInt("${PREFIX}total_stages", 16)
