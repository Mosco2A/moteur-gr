/// Tous les hébergements le long du GR20.
...
class Gr20Accommodation {
  const Gr20Accommodation({
    required this.name,
    required this.type,
  ...
  /// Deserialise un Gr20Accommodation depuis un JSON (Firebase Storage).
  factory Gr20Accommodation.fromJson(Map<String, dynamic> json) {
    return Gr20Accommodation(
...
/// Modes de confort du GR20 (du plus spartiate au plus confortable).
enum ComfortMode {
...
/// Tous les hébergements du GR20 (Nord → Sud).
const List<Gr20Accommodation> gr20Accommodations = [
...
List<Gr20Accommodation> accommodationsForStage(int stageNumber) {
...
List<Gr20Accommodation> accommodationsForComfort(ComfortMode mode) {
  return gr20Accommodations
...
List<Gr20Accommodation> accommodationsForStageAndComfort(
  int stageNumber,
  ComfortMode mode,
) {
  return gr20Accommodations
      .where((a) => a.stageNumber == stageNumber && a.comfortModes.contains(mode))
      .toList();
}
