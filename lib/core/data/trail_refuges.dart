/// Données statiques des refuges et hébergements d'un sentier.
/// Coordonnées GPS reelles issues des topos officiels et du PNRC.
///
/// Refuges + bergeries et gites prives le long du sentier.
class TrailRefuge {
  const TrailRefuge({
  ...
  /// Deserialise un TrailRefuge depuis un JSON (Firebase Storage).
  factory TrailRefuge.fromJson(Map<String, dynamic> json) {
    return TrailRefuge(
...
/// Types d'hébergement le long d'un sentier.
enum RefugeType {
...
/// Refuges PNRC du GR20 (Nord → Sud) — données de référence.
...
const List<TrailRefuge> gr20RefugesPNRC = [
...
/// Bergeries et gites prives le long du GR20 — données de référence.
const List<TrailRefuge> gr20BergeriesGites = [
...
/// Tous les hébergements combinés (PNRC + privés) du GR20.
final List<TrailRefuge> gr20AllRefuges = [
  ...gr20RefugesPNRC,
  ...gr20BergeriesGites,
];
