...
/// Identifiant unique du sentier (ex: 'gr20', 'mare_a_mare')
 ...
 String get filePath;/// Taille du fichier en octets
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,trailId,dataVersion,hash,filePath,fileSize,status,lastUpdated);
...
@useResult
$Res call({
 String trailId, int dataVersion, String hash, String filePath, int fileSize, String status, String lastUpdated
});
...
/// Create a copy of TrailManifestEntry
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? trailId = null,Object? dataVersion = null,Object? hash = null,Object? filePath = null,Object? fileSize = null,Object? status = null,Object? lastUpdated = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String trailId,  int dataVersion,  String hash,  String filePath,  int fileSize,  String status,  String lastUpdated)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TrailManifestEntry() when $default != null:
return $default(_that.trailId,_that.dataVersion,_that.hash,_that.filePath,_that.fileSize,_that.status,_that.lastUpdated);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String trailId,  int dataVersion,  String hash,  String filePath,  int fileSize,  String status,  String lastUpdated)  $default,) {final _that = this;
switch (_that) {
case _TrailManifestEntry():
return $default(_that.trailId,_that.dataVersion,_that.hash,_that.filePath,_that.fileSize,_that.status,_that.lastUpdated);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String trailId,  int dataVersion,  String hash,  String filePath,  int fileSize,  String status,  String lastUpdated)?  $default,) {final _that = this;
switch (_that) {
case _TrailManifestEntry() when $default != null:
return $default(_that.trailId,_that.dataVersion,_that.hash,_that.filePath,_that.fileSize,_that.status,_that.lastUpdated);case _:
  return null;
...
/// Create a copy of TrailManifestEntry
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? trailId = null,Object? dataVersion = null,Object? hash = null,Object? filePath = null,Object? fileSize = null,Object? status = null,Object? lastUpdated = null,}) {
