...
mixin _$DeltaUpdate {
  ...
  $DeltaUpdateCopyWith<DeltaUpdate> get copyWith =>
      _$DeltaUpdateCopyWithImpl<DeltaUpdate>(this as DeltaUpdate, _$identity);
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.changedTables, changedTables) &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, trailId, fromVersion, toVersion,
      const DeepCollectionEquality().hash(changedTables), downloadSize);
...
abstract mixin class $DeltaUpdateCopyWith<$Res> {
  factory $DeltaUpdateCopyWith(
          DeltaUpdate value, $Res Function(DeltaUpdate) _then) =
      _$DeltaUpdateCopyWithImpl;
  @useResult
  $Res call(
      {String trailId,
      int fromVersion,
...
/// @nodoc
class _$DeltaUpdateCopyWithImpl<$Res> implements $DeltaUpdateCopyWith<$Res> {
    ...
    return _then(_self.copyWith(
      ...
      toVersion: null == toVersion
          ...
          : toVersion // ignore: cast_nullable_to_non_nullable
              as int,
      changedTables: null == changedTables
          ? _self.changedTables
          : changedTables // ignore: cast_nullable_to_non_nullable
              as List<String>,
...
extension DeltaUpdatePatterns on DeltaUpdate {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_DeltaUpdate value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String trailId, int fromVersion, int toVersion,
            List<String> changedTables, int downloadSize)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _DeltaUpdate() when $default != null:
        return $default(_that.trailId, _that.fromVersion, _that.toVersion,
            _that.changedTables, _that.downloadSize);
      case _:
        return orElse();
    }
  }
...
class _DeltaUpdate implements DeltaUpdate {
  const _DeltaUpdate(
      ...
      required final List<String> changedTables,
      required this.downloadSize})
      : _changedTables = changedTables;
  factory _DeltaUpdate.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$DeltaUpdateCopyWith<_DeltaUpdate> get copyWith =>
      __$DeltaUpdateCopyWithImpl<_DeltaUpdate>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$DeltaUpdateToJson(
      this,
    );
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.toVersion, toVersion) ||
                other.toVersion == toVersion) &&
            const DeepCollectionEquality()
                .equals(other._changedTables, _changedTables) &&
            (identical(other.downloadSize, downloadSize) ||
                other.downloadSize == downloadSize));
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, trailId, fromVersion, toVersion,
      const DeepCollectionEquality().hash(_changedTables), downloadSize);
...
/// @nodoc
abstract mixin class _$DeltaUpdateCopyWith<$Res>
    implements $DeltaUpdateCopyWith<$Res> {
  factory _$DeltaUpdateCopyWith(
          _DeltaUpdate value, $Res Function(_DeltaUpdate) _then) =
      __$DeltaUpdateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String trailId,
...
/// @nodoc
class __$DeltaUpdateCopyWithImpl<$Res> implements _$DeltaUpdateCopyWith<$Res> {
