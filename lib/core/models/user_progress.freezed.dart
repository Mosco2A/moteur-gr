...
mixin _$UserProgressModel {
  ...
  $UserProgressModelCopyWith<UserProgressModel> get copyWith =>
      _$UserProgressModelCopyWithImpl<UserProgressModel>(
          this as UserProgressModel, _$identity);
...
abstract mixin class $UserProgressModelCopyWith<$Res> {
  factory $UserProgressModelCopyWith(
          UserProgressModel value, $Res Function(UserProgressModel) _then) =
      _$UserProgressModelCopyWithImpl;
  @useResult
  $Res call(
      {int id,
      String trailId,
...
extension UserProgressModelPatterns on UserProgressModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UserProgressModel value)? $default, {
    ...
    switch (_that) {
      case _UserProgressModel() when $default != null:
        return $default(
            ...
            _that.trailId,
            _that.currentStage,
            _that.totalDistanceWalkedKm,
            _that.totalElevationGainedM,
...
class _UserProgressModel extends UserProgressModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UserProgressModelCopyWith<_UserProgressModel> get copyWith =>
      __$UserProgressModelCopyWithImpl<_UserProgressModel>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UserProgressModel &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.trailId, trailId) || other.trailId == trailId) &&
            (identical(other.currentStage, currentStage) ||
                other.currentStage == currentStage) &&
...
/// @nodoc
abstract mixin class _$UserProgressModelCopyWith<$Res>
    implements $UserProgressModelCopyWith<$Res> {
  factory _$UserProgressModelCopyWith(
          _UserProgressModel value, $Res Function(_UserProgressModel) _then) =
      __$UserProgressModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int id,
