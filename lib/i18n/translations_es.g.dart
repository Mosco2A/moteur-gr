...
class TranslationsEs extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _Translations$navPilote$es navPilote = _Translations$navPilote$es._(_root);
	...
	@override late final _Translations$erasure$es erasure = _Translations$erasure$es._(_root);
	...
	@override late final _Translations$fireRisk$es fireRisk = _Translations$fireRisk$es._(_root);
	...
	@override late final _Translations$hikerProfile$es hikerProfile = _Translations$hikerProfile$es._(_root);
	@override late final _Translations$walkTest$es walkTest = _Translations$walkTest$es._(_root);
	@override late final _Translations$pastHikes$es pastHikes = _Translations$pastHikes$es._(_root);
	@override late final _Translations$ffrando$es ffrando = _Translations$ffrando$es._(_root);
...
// Path: navPilote
class _Translations$navPilote$es extends Translations$navPilote$fr {
	_Translations$navPilote$es._(TranslationsEs root) : this._root = root, super.internal(root);
	...
	@override String demoLockedTitle({required Object phase}) => '${phase} — solo para treks comprados';
	@override String get demoLockedBody => 'En modo demo, solo está disponible la preparación. Desbloquea este trek para caminar y revivir tu aventura.';
	...
	@override String get weatherBannerTitle => 'Aquí y ahora';
	@override String get weatherBannerStages => 'Meteo por etapas';
	@override String get weatherBannerUnavailable => 'Meteo localizada no disponible';
}
...
class _Translations$hub$es extends Translations$hub$fr {
	...
	@override late final _Translations$hub$finishTrek$es finishTrek = _Translations$hub$finishTrek$es._(_root);
}
...
class _Translations$poi$es extends Translations$poi$fr {
	...
	@override String get accommodation => 'Alojamiento';
...
class _Translations$itinerary$es extends Translations$itinerary$fr {
	...
	@override String stageCount({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('es'))(n,
		one: '${n} etapa',
		other: '${n} etapas',
	);
	@override String get daysTotal => 'Días en total';
	@override String daysBreakdown({required Object walk, required Object rest}) => '${walk} días de marcha + ${rest} días de descanso';
}
...
class _Translations$tracking$es extends Translations$tracking$fr {
	...
	@override String get stopBody => 'Tu progreso se guardará.';
	@override String get dMinus => 'D-';
...
class _Translations$checklist$es extends Translations$checklist$fr {
	...
	@override String seasonalBanner({required Object season}) => 'Mochila adaptada a la temporada (${season}) y a tu sendero.';
	@override late final _Translations$checklist$seasons$es seasons = _Translations$checklist$seasons$es._(_root);
...
class _Translations$journal$es extends Translations$journal$fr {
	...
	@override String get photoAdded => 'Foto añadida al diario';
	@override String get photoSource => 'Origen de la foto';
	@override String get camera => 'Cámara';
	@override String get gallery => 'Galería';
	@override String get removePhoto => 'Quitar la foto';
	@override String get photoError => 'No se ha podido añadir la foto';
	@override String get dayNavPrevious => 'Día anterior';
	@override String get dayNavNext => 'Día siguiente';
	@override String dayOfTrek({required Object day}) => 'Día ${day}';
	@override String dayCounter({required Object index, required Object total}) => '${index} / ${total}';
	@override String get dayEmpty => 'Ninguna nota para este día';
	@override String get entriesOfDay => 'Notas del día';
	@override String get dayTrace => 'Traza del día';
	@override String get dayTraceEmpty => 'No se registró ninguna traza GPS ese día';
	@override String get daySummary => 'Resumen del día';
	@override String get sinceStart => 'Desde el inicio';
	@override String get distance => 'Distancia';
	@override String get elevationGain => 'Desnivel positivo';
	@override String get elevationLoss => 'Desnivel negativo';
	@override String get duration => 'Duración';
	@override String get maxAltitude => 'Altitud máxima';
	@override String get share => 'Compartir';
	@override String get shareSubject => 'Mi diario de senderismo';
...
class _Translations$settings$es extends Translations$settings$fr {
	...
	@override String get noDateChosen => 'Ninguna fecha elegida';
...
class _Translations$feasibility$es extends Translations$feasibility$fr {
	...
	@override late final _Translations$feasibility$flow$es flow = _Translations$feasibility$flow$es._(_root);
}
...
class _Translations$onboarding$es extends Translations$onboarding$fr {
	...
	@override String get recoveryNudge => 'Recuerda anotar tu código de recuperación (en ajustes): abre tus datos en otro teléfono.';
}
...
class _Translations$training$es extends Translations$training$fr {
	...
	@override String progress({required Object done, required Object total}) => '${done} de ${total} sesiones hechas';
	...
	@override String freqPerWeek({required Object n}) => '${n}× por semana';
	@override String get freqOncePerPhase => 'una vez en la fase';
	@override String get freqFinalWeek => 'solo la última semana';
	@override String get freqSourceNotice => 'Las frecuencias no son cifras de la casa: 3 sesiones de resistencia y 2 de refuerzo por semana, 2 días de descanso, según REI (Conditioning for Backpacking), Terres d\'Aventure y las recomendaciones de la OMS de 2020.';
...
// Path: erasure
class _Translations$erasure$es extends Translations$erasure$fr {
	_Translations$erasure$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$programme$es extends Translations$programme$fr {
	...
	@override late final _Translations$programme$duration$es duration = _Translations$programme$duration$es._(_root);
...
// Path: transport
class _Translations$transport$es extends Translations$transport$fr {
	_Translations$transport$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Transporte';
	@override String get tabJoin => 'Llegar a la salida';
	@override String tabJoinNamed({required Object name}) => 'Llegar a ${name}';
	@override String get tabLeave => 'Salir de la llegada';
	@override String tabLeaveNamed({required Object name}) => 'Salir de ${name}';
	@override String joinTitle({required Object name}) => 'Llegar a ${name}';
	@override String leaveTitle({required Object name}) => 'Salir de ${name}';
	@override String get adviceTitle => 'Consejos prácticos';
	@override String get website => 'Sitio web';
	@override late final _Translations$transport$a11y$es a11y = _Translations$transport$a11y$es._(_root);
	@override String get noneForTrail => 'No hay información de transporte para este sendero.';
}

// Path: fireRisk
class _Translations$fireRisk$es extends Translations$fireRisk$fr {
	_Translations$fireRisk$es._(TranslationsEs root) : this._root = root, super.internal(root);
	...
	@override String get stagesTitle => 'Riesgo por etapa';
	...
	@override String get refreshNothing => 'Nada que actualizar por ahora.';
	@override String refreshPartial({required Object done, required Object total}) => 'Actualización parcial: ${done} etapa(s) de ${total}.';
	@override String refreshedAt({required Object date}) => 'Datos actualizados (${date})';
	@override String stagePlace({required Object place}) => 'Llegada: ${place}';
}

// Path: shop
class _Translations$shop$es extends Translations$shop$fr {
	_Translations$shop$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Avituallamiento';
	@override String get filterAll => 'Todos';
	@override String get typeEpicerie => 'Tienda';
	@override String get typeBar => 'Bar/Restaurante';
	@override String get typePharmacie => 'Farmacia';
	@override String get typeGaz => 'Gas/Material';
	@override String get limitedTitle => 'Puntos de avituallamiento limitados';
	@override String stageHeader({required Object n}) => 'Etapa ${n}';
	@override String stageBadge({required Object n}) => 'Etapa ${n}';
	@override String gapShort({required Object n}) => 'Último avituallamiento antes de ${n} etapas sin comercio';
	@override String gapLong({required Object n}) => 'Último avituallamiento antes de ${n} etapas sin comercio. ¡Abastécete!';
	@override String get sectionInfo => 'Información';
	@override String get sectionProducts => 'Productos disponibles';
	@override String get fieldType => 'Tipo';
	@override String get fieldStage => 'Etapa';
	@override String get fieldGps => 'GPS';
	@override String get fieldHours => 'Horario';
	@override String get website => 'Sitio web';
...
// Path: import
class _Translations$import$es extends Translations$import$fr {
	_Translations$import$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Importar un GPX';
	@override String get headerTitle => 'Importar un archivo GPX';
	@override String get headerBody => 'Importa una traza GPS registrada con otra aplicación (Strava, Garmin, etc.) para generar tu resumen.';
	@override String get pickButton => 'ELEGIR UN ARCHIVO GPX';
	@override String get traceSection => 'Traza importada';
	@override String get statsSection => 'Estadísticas';
	@override String get statDistance => 'Distancia';
	@override String get statElevationGain => 'Desnivel +';
	@override String get statElevationLoss => 'Desnivel -';
	@override String get statDuration => 'Duración';
	@override String get statDirection => 'Dirección';
	@override String get statPoints => 'Puntos GPS';
	@override String get directionNS => 'Norte-Sur';
	@override String get directionSN => 'Sur-Norte';
	@override String get stagesSection => 'Etapas detectadas';
	@override String get stagesCount => '{done}/{total}';
	@override String get stageBadge => 'E{number}';
	@override String get warningsSection => 'Advertencias';
	@override String get warningOutOfBounds => '{count} punto(s) fuera de zona ignorados.';
	@override String get warningOffTrail => 'El {percent}% de los puntos está lejos del sendero.';
	@override String get invalidTooFewPoints => 'Archivo GPX insuficiente: {count} puntos (mínimo 10).';
	@override String get invalidOutOfBounds => 'La traza no corresponde a la zona de este sendero.';
	@override String get errorUnreadable => 'No se puede leer el archivo.';
	@override String get errorParsing => 'No se pudo leer el archivo GPX.';
	@override String get validateButton => 'CONFIRMAR IMPORTACIÓN';
	@override String get confirmTitle => '¿Confirmar la importación?';
	@override String get confirmBody => 'Esta traza se importará como tu recorrido:\n\n- {points} puntos GPS\n- {km} km\n- {stages} etapas detectadas\n- Dirección: {direction}';
	@override String get cancel => 'Cancelar';
	@override String get validate => 'Confirmar';
...
class _Translations$trekState$es extends Translations$trekState$fr {
	...
	@override late final _Translations$trekState$resumeOrphanDialog$es resumeOrphanDialog = _Translations$trekState$resumeOrphanDialog$es._(_root);
}

// Path: hikerProfile
class _Translations$hikerProfile$es extends Translations$hikerProfile$fr {
	_Translations$hikerProfile$es._(TranslationsEs root) : this._root = root, super.internal(root);
	...
	@override String get errorAge => 'Edad no válida (18 a 120 años)';
	@override String get ageUsage => 'Para qué sirve tu edad: fija la distancia de referencia de tu prueba de marcha y baja un nivel el asignado a partir de los 60 años, dos a partir de los 75. No sirve para nada más, y nada de eso sale de tu teléfono.';
	@override String get fieldHeight => 'Altura';
	@override String get hintHeight => 'En centímetros';
	@override String get errorHeight => 'Altura no válida (60 a 255 cm)';
...
// Path: walkTest
class _Translations$walkTest$es extends Translations$walkTest$fr {
	_Translations$walkTest$es._(TranslationsEs root) : this._root = root, super.internal(root);
	...
	@override String get resultTitle => 'Resultado de la prueba';
	@override String get resultDistance => 'Distancia recorrida';
	@override String get resultLevel => 'Nivel estimado';
	...
	@override String get absoluteScaleNotice => 'Tu nivel se lee en la escala de distancia bruta: la comparación con una referencia no se estableció para tu constitución, así que no la aplicamos. Tu test sigue siendo perfectamente válido.';
	@override String get ageClampNotice => 'Más allá de los 80 años la referencia del test se detiene: se calcula como a los 80, y te lo decimos.';
	@override String get gpsUnavailable => 'La ubicación no está disponible en este dispositivo: la prueba no puede medir la distancia.';
}

// Path: pastHikes
class _Translations$pastHikes$es extends Translations$pastHikes$fr {
	_Translations$pastHikes$es._(TranslationsEs root) : this._root = root, super.internal(root);
	...
	@override String get fieldAvgHours => 'Tiempo de marcha por día (h)';
	...
	@override String get save => 'Guardar';
	@override String get backToFeasibility => 'Volver a la viabilidad';
	@override String get saved => 'Rutas guardadas';
	@override String get maxReached => 'Máximo de 5 rutas alcanzado.';
}

// Path: ffrando
class _Translations$ffrando$es extends Translations$ffrando$fr {
	_Translations$ffrando$es._(TranslationsEs root) : this._root = root, super.internal(root);
	...
	@override String get notRated => 'Sin clasificar';
	@override late final _Translations$ffrando$effortLevels$es effortLevels = _Translations$ffrando$effortLevels$es._(_root);
}

// Path: sos
class _Translations$sos$es extends Translations$sos$fr {
	_Translations$sos$es._(TranslationsEs root) : this._root = root, super.internal(root);
	...
	@override String cannotCall({required Object number}) => 'Este dispositivo no puede realizar la llamada. Marca ${number}.';
}

// Path: recovery
class _Translations$recovery$es extends Translations$recovery$fr {
...
// Path: common
class _Translations$common$es extends Translations$common$fr {
	_Translations$common$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get cannotLoadStages => 'No se pueden cargar las etapas';
	@override String get noStages => 'No hay etapas disponibles';
	@override String get cannotLoadStage => 'No se puede cargar esta etapa';
	@override String get stageNotFound => 'Etapa no encontrada';
	@override String get cannotLoadTrack => 'No se puede cargar el trazado';
	@override String get loadingTrack => 'Cargando el trazado…';
	@override String get gpxEmpty => 'El archivo GPX no contiene ningún punto.';
	@override String get noPoiForStage => 'Ningún punto de interés para esta etapa.';
	@override String get viewOnMap => 'Ver en el mapa';
	@override String get error => 'Error';
	@override String pageNotFound({required Object path}) => 'Página no encontrada: ${path}';
...
class _Translations$hub$cards$es extends Translations$hub$cards$fr {
	...
	@override String get transportSub => 'Ida y vuelta';
	...
	@override String get importGpx => 'Importar GPX';
	@override String get importGpxSub => 'Importar una traza GPS';
	...
	@override String get shop => 'Avituallamiento';
	@override String get shopSub => 'Tiendas, farmacias, gas';
...
// Path: hub.finishTrek
class _Translations$hub$finishTrek$es extends Translations$hub$finishTrek$fr {
	_Translations$hub$finishTrek$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: map.guide
class _Translations$map$guide$es extends Translations$map$guide$fr {
	_Translations$map$guide$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$tracking$backgroundRationale$es extends Translations$tracking$backgroundRationale$fr {
	_Translations$tracking$backgroundRationale$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Registrar tu recorrido con la pantalla apagada';
	@override String get body => 'Durante la ruta, StepWays registra tu recorrido de forma continua, incluso con el móvil en el bolsillo. Android te pedirá permitir la ubicación «Siempre»: es solo para eso, y únicamente mientras haya una ruta en curso.';
...
class _Translations$checklist$categories$es extends Translations$checklist$categories$fr {
	...
	@override String get firstAid => 'Botiquín';
	@override String get electronics => 'Electrónica';
...
class _Translations$checklist$items$es extends Translations$checklist$items$fr {
	...
	@override String get sleepingLiner => 'Sábana saco / funda';
	@override String get pillow => 'Almohada hinchable';
	@override String get hikingPants => 'Pantalón de senderismo';
	@override String get rainPants => 'Pantalón de lluvia';
	@override String get shorts => 'Pantalón corto';
	@override String get techTshirt => 'Camiseta técnica';
	...
	@override String get energyBars => 'Barrita energética';
	...
	@override String get soap => 'Jabón biodegradable';
	...
	@override String get sterileCompresses => 'Compresas estériles';
	@override String get elasticBandage => 'Venda elástica';
	...
	@override String get antihistamine => 'Antihistamínico';
	@override String get kneeTape => 'Tape para rodillas';
	@override String get phone => 'Teléfono';
	@override String get powerBank => 'Batería externa 20000mAh';
	...
	@override String get dogKibble => 'Pienso (ración/día)';
	@override String get dogBooties => 'Botines de protección';
	@override String get dogVaccineBook => 'Cartilla de vacunas';
	@override String get dogPoopBags => 'Bolsas para excrementos';
	@override String get swimsuit => 'Bañador';
	@override String get seasonalMicrospikes => 'Crampones ligeros (microspikes)';
	@override String get seasonalWarmGloves => 'Guantes cálidos';
	@override String get seasonalThermalBase => 'Capa base térmica';
	@override String get seasonalExtraWater => 'Agua adicional';
	@override String get seasonalSunHat => 'Sombrero para el sol';
	@override String get seasonalElectrolytesPlus => 'Electrolitos (calor)';
	@override String get seasonalGaitersMud => 'Polainas (barro de primavera)';
	@override String get seasonalHeadlampSpare => 'Linterna frontal de repuesto (días cortos)';
	@override String get seasonalMamExtraWater => 'Reserva de agua reforzada (zonas secas)';
}
...
class _Translations$checklist$weight$es extends Translations$checklist$weight$fr {
	...
	@override String get perItem => 'Peso por artículo';
	...
	@override String get adviceDanger => 'Riesgo de lesión — aligera ya!';
	@override String get itemWeight => 'Peso del artículo';
	@override String get cancel => 'Cancelar';
	@override String get save => 'Guardar';
	...
	@override String get gaugeDanger => 'Riesgo de lesión!';
	@override String get percentOfWeight => '{pct}% del peso corporal';
	@override String get gaugeObjective => 'Objetivo máx: < 15% en refugio, < 20% en autonomía';
	@override String get itemsChecked => '{checked} / {total} artículos marcados';
	@override String get percentOfReference => '{pct}% del peso de referencia';
	@override String get gaugeObjectiveReference => 'Objetivo máx: < 15% en refugio, < 20% en autonomía — del peso de referencia';
	@override String get referenceExplainer => 'Peso de referencia para tu estatura: {kg} kg. El tope de la mochila se calcula sobre él, no sobre tu peso real.';
	@override String get referenceFallbackHeight => 'El tope de tu mochila se calcula sobre tu peso real: para tu estatura no existe un peso de referencia publicado en el que apoyarse. Preferimos decírtelo antes que mostrarte una cifra falsa.';
	@override String get descentAlertTitle => 'Bajadas: lo que llevas';
	@override String get descentAlertBody => 'Dos pesos bajan contigo: {pack} kg de mochila y {above} kg por encima de tu peso de forma. En bajada, cada paso hace pasar por la rodilla 3,46 veces el peso que baja contigo, frente a 2,61 en llano. Solo la mochila se puede cambiar hoy: aligérala, y es menos en cada paso.';
	@override String get descentAlertBodyPackOnly => 'Bajas con {pack} kg de mochila. En bajada, cada paso hace pasar por la rodilla 3,46 veces el peso que baja contigo, frente a 2,61 en llano: aligera la mochila, y es menos en cada paso.';
	@override String get descentStage => '{stage}: {loss} m de bajada';
}
...
class _Translations$checklist$ui$es extends Translations$checklist$ui$fr {
	...
	@override String get addItem => 'Añadir un artículo';
	@override String get addItemTitle => 'Añadir un artículo';
	@override String get fieldName => 'Nombre';
	@override String get fieldWeightGrams => 'Peso (gramos)';
	@override String get errorWeightGrams => 'Peso no válido (0 a 50 000 g)';
	@override String get errorNameRequired => 'Nombre obligatorio';
	@override String get add => 'Añadir';
	@override String get editWeightTitle => 'Editar el peso';
	@override String get editCustomTitle => 'Editar artículo personalizado';
	@override String get modify => 'Editar';
	@override String get delete => 'Eliminar';
	@override String get deleteItemTitle => 'Eliminar este artículo?';
	@override String get deleteItemBody => 'El artículo "{name}" se eliminará definitivamente.';
	...
	@override String get addToShoppingList => 'Añadir a la lista de la compra';
	...
	@override String get infoCheckTitle => 'Marca los artículos';
	...
	@override String get infoRequiredBody => 'Artículos con candado = reglamento (silbato, linterna, manta de supervivencia).';
	...
	@override String get cancelValidation => 'ANULAR LA VALIDACIÓN';
	...
	@override String get validationCancelledSnack => 'Validación anulada — puedes modificar tu equipo.';
	@override String get missingTitle => 'Equipo faltante';
	@override String get missingBody => '{checked}/{total} artículos obligatorios marcados.';
	...
	@override String get bagValidatedMissingSnack => 'Mochila validada (con artículos faltantes)!';
	@override String get shareGroupHint => 'Únete a un grupo para compartir tu checklist.';
	@override String get shareFailed => 'No se ha podido abrir la función de compartir en este dispositivo.';
}

// Path: checklist.seasons
class _Translations$checklist$seasons$es extends Translations$checklist$seasons$fr {
	_Translations$checklist$seasons$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$weather$program$es extends Translations$weather$program$fr {
	_Translations$weather$program$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Meteorología etapa por etapa';
	@override String get subtitle => 'El tiempo donde estarás, el día en que estarás allí.';
	@override String dayLabel({required Object day}) => 'Día ${day}';
	@override String get restDay => 'Descanso';
	@override String place({required Object place}) => 'en ${place}';
	@override String get trendBadge => 'Tendencia';
	@override String trendHint({required Object reliable}) => 'Más allá de ${reliable} días solo es una tendencia: una previsión a 10 días acierta una vez de cada dos.';
...
class _Translations$weather$duration$es extends Translations$weather$duration$fr {
	_Translations$weather$duration$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get seconds => 'unos segundos';
	@override String minutes({required Object n}) => '${n} min';
...
class _Translations$feasibility$formula$es extends Translations$feasibility$formula$fr {
	...
	@override String hardestStage({required Object stage}) => 'Jornada más exigente: ${stage}';
...
class _Translations$feasibility$flow$es extends Translations$feasibility$flow$fr {
	_Translations$feasibility$flow$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$tips$themes$es extends Translations$tips$themes$fr {
	...
	// Translations
	@override String get gear => 'Material';
	@override String get safety => 'Seguridad';
	@override String get health => 'Salud';
	@override String get weather => 'Meteo';
	@override String get refuge => 'Vida en refugio';
	@override String get nature => 'Naturaleza';
	@override String get other => 'Varios';
}
...
class _Translations$packs$actions$es extends Translations$packs$actions$fr {
	...
	@override String get buyUnavailable => 'La compra no está disponible en este dispositivo.';
}
...
class _Translations$packs$progress$es extends Translations$packs$progress$fr {
	...
	@override String get errorSnack => 'La descarga no se ha completado.';
}
...
// Path: health.delete
class _Translations$health$delete$es extends Translations$health$delete$fr {
	_Translations$health$delete$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get button => 'Borrar mi ficha';
	@override String get a11yButton => 'Borrar mi ficha de salud — acción definitiva';
	@override String get confirmTitle => '¿Borrar tu ficha de salud?';
	@override String get confirmBody => 'Es definitivo y local. Tu información se eliminará de este teléfono.';
	@override String get cancel => 'Cancelar';
	@override String get confirm => 'Borrar';
	@override String get done => 'Ficha de salud borrada.';
}

// Path: health.consent
class _Translations$health$consent$es extends Translations$health$consent$fr {
	_Translations$health$consent$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: erasure.a11y
class _Translations$erasure$a11y$es extends Translations$erasure$a11y$fr {
	_Translations$erasure$a11y$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get entry => 'Borrar mis datos, abre una solicitud de confirmación';
}
...
class _Translations$programme$duration$es extends Translations$programme$duration$fr {
	_Translations$programme$duration$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$programme$splitBlocked$es extends Translations$programme$splitBlocked$fr {
	_Translations$programme$splitBlocked$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$nuitees$card$es extends Translations$nuitees$card$fr {
	...
	@override String get eveBadge => 'D-1';
	@override String get eveOfDeparture => 'Víspera de la salida';
}
...
// Path: transport.a11y
class _Translations$transport$a11y$es extends Translations$transport$a11y$fr {
	_Translations$transport$a11y$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String call({required Object label}) => 'Llamar a ${label}';
	@override String get website => 'Abrir el sitio web';
}

// Path: fireRisk.update
class _Translations$fireRisk$update$es extends Translations$fireRisk$update$fr {
	_Translations$fireRisk$update$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$fireRisk$duration$es extends Translations$fireRisk$duration$fr {
	_Translations$fireRisk$duration$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$fireRisk$regulation$es extends Translations$fireRisk$regulation$fr {
	_Translations$fireRisk$regulation$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: fireRisk.level
class _Translations$fireRisk$level$es extends Translations$fireRisk$level$fr {
	_Translations$fireRisk$level$es._(TranslationsEs root) : this._root = root, super.internal(root);
	...
	@override String get veryHigh => 'Muy alto';
	@override String get extreme => 'Extremo';
}

// Path: fireRisk.day
class _Translations$fireRisk$day$es extends Translations$fireRisk$day$fr {
	_Translations$fireRisk$day$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$fireRisk$number$es extends Translations$fireRisk$number$fr {
	_Translations$fireRisk$number$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get firefighters => 'Bomberos';
	@override String get europeanEmergency => 'Emergencia europea';
}

// Path: fireRisk.empty
class _Translations$fireRisk$empty$es extends Translations$fireRisk$empty$fr {
	_Translations$fireRisk$empty$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: fireRisk.a11y
class _Translations$fireRisk$a11y$es extends Translations$fireRisk$a11y$fr {
	_Translations$fireRisk$a11y$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: shop.a11y
class _Translations$shop$a11y$es extends Translations$shop$a11y$fr {
	_Translations$shop$a11y$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String openDetail({required Object name}) => 'Ver detalles de ${name}';
	@override String call({required Object label}) => 'Llamar a ${label}';
	@override String get website => 'Abrir el sitio web';
}
...
class _Translations$trekState$resumeOrphanDialog$es extends Translations$trekState$resumeOrphanDialog$fr {
	_Translations$trekState$resumeOrphanDialog$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get title => '¿Reanudar tu excursión?';
	@override String get message => 'Había una excursión en curso al cerrar la aplicación por última vez. ¿Quieres reanudarla o abandonarla?';
	@override String get resume => 'Reanudar';
	@override String get abandon => 'Abandonar';
}

// Path: walkTest.levels
class _Translations$walkTest$levels$es extends Translations$walkTest$levels$fr {
	_Translations$walkTest$levels$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get low => 'Bajo';
	@override String get moderate => 'Medio';
	@override String get good => 'Bueno';
	@override String get excellent => 'Excelente';
}

// Path: ffrando.effortLevels
class _Translations$ffrando$effortLevels$es extends Translations$ffrando$effortLevels$fr {
	_Translations$ffrando$effortLevels$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: sos.medicalId
class _Translations$sos$medicalId$es extends Translations$sos$medicalId$fr {
	_Translations$sos$medicalId$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: map.guide.poi
class _Translations$map$guide$poi$es extends Translations$map$guide$poi$fr {
	_Translations$map$guide$poi$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$feasibility$formula$limitingFactors$es extends Translations$feasibility$formula$limitingFactors$fr {
	...
	// Translations
	@override String get distance => 'la distancia por día';
	@override String get elevation => 'el desnivel';
	@override String get chaining => 'el encadenamiento de los días';
	@override String get none => 'ninguno';
	@override String get altitude => 'la altitud';
	@override String get heat => 'el calor de la estación';
}
...
extension on TranslationsEs {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'navPilote.prepare' => 'Preparar',
			'navPilote.hike' => 'Caminar',
			'navPilote.after' => 'Después',
			'navPilote.sos' => 'SOS',
			'navPilote.demoLockedTitle' => ({required Object phase}) => '${phase} — solo para treks comprados',
			'navPilote.demoLockedBody' => 'En modo demo, solo está disponible la preparación. Desbloquea este trek para caminar y revivir tu aventura.',
			...
			'navPilote.weatherBannerTitle' => 'Aquí y ahora',
			'navPilote.weatherBannerStages' => 'Meteo por etapas',
			'navPilote.weatherBannerUnavailable' => 'Meteo localizada no disponible',
			...
			'hub.cards.transport' => 'Transporte',
			'hub.cards.transportSub' => 'Ida y vuelta',
			...
			'hub.cards.importGpx' => 'Importar GPX',
			'hub.cards.importGpxSub' => 'Importar una traza GPS',
			...
			'hub.cards.shop' => 'Avituallamiento',
			'hub.cards.shopSub' => 'Tiendas, farmacias, gas',
			...
			'itinerary.stageCount' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('es'))(n, one: '${n} etapa', other: '${n} etapas', ), 
			'itinerary.daysTotal' => 'Días en total',
			'itinerary.daysBreakdown' => ({required Object walk, required Object rest}) => '${walk} días de marcha + ${rest} días de descanso',
			...
			'tracking.stopBody' => 'Tu progreso se guardará.',
			'tracking.dMinus' => 'D-',
			...
			'checklist.categories.firstAid' => 'Botiquín',
			'checklist.categories.electronics' => 'Electrónica',
			...
			'checklist.items.sleepingLiner' => 'Sábana saco / funda',
			'checklist.items.pillow' => 'Almohada hinchable',
			'checklist.items.hikingPants' => 'Pantalón de senderismo',
			'checklist.items.rainPants' => 'Pantalón de lluvia',
			'checklist.items.shorts' => 'Pantalón corto',
			'checklist.items.techTshirt' => 'Camiseta técnica',
			...
			'checklist.items.energyBars' => 'Barrita energética',
			...
			'checklist.items.soap' => 'Jabón biodegradable',
			...
			'checklist.items.sterileCompresses' => 'Compresas estériles',
			'checklist.items.elasticBandage' => 'Venda elástica',
			...
			'checklist.items.antihistamine' => 'Antihistamínico',
			'checklist.items.kneeTape' => 'Tape para rodillas',
			'checklist.items.phone' => 'Teléfono',
			'checklist.items.powerBank' => 'Batería externa 20000mAh',
			...
			'checklist.items.dogKibble' => 'Pienso (ración/día)',
			'checklist.items.dogBooties' => 'Botines de protección',
			'checklist.items.dogVaccineBook' => 'Cartilla de vacunas',
			'checklist.items.dogPoopBags' => 'Bolsas para excrementos',
			'checklist.items.swimsuit' => 'Bañador',
			'checklist.items.seasonalMicrospikes' => 'Crampones ligeros (microspikes)',
			'checklist.items.seasonalWarmGloves' => 'Guantes cálidos',
			'checklist.items.seasonalThermalBase' => 'Capa base térmica',
			'checklist.items.seasonalExtraWater' => 'Agua adicional',
			'checklist.items.seasonalSunHat' => 'Sombrero para el sol',
			'checklist.items.seasonalElectrolytesPlus' => 'Electrolitos (calor)',
			'checklist.items.seasonalGaitersMud' => 'Polainas (barro de primavera)',
			'checklist.items.seasonalHeadlampSpare' => 'Linterna frontal de repuesto (días cortos)',
			...
			'checklist.weight.perItem' => 'Peso por artículo',
			...
			'checklist.weight.adviceDanger' => 'Riesgo de lesión — aligera ya!',
			'checklist.weight.itemWeight' => 'Peso del artículo',
			...
			'checklist.weight.gaugeDanger' => 'Riesgo de lesión!',
			'checklist.weight.percentOfWeight' => '{pct}% del peso corporal',
			'checklist.weight.gaugeObjective' => 'Objetivo máx: < 15% en refugio, < 20% en autonomía',
			'checklist.weight.itemsChecked' => '{checked} / {total} artículos marcados',
			'checklist.weight.percentOfReference' => '{pct}% del peso de referencia',
			'checklist.weight.gaugeObjectiveReference' => 'Objetivo máx: < 15% en refugio, < 20% en autonomía — del peso de referencia',
			'checklist.weight.referenceExplainer' => 'Peso de referencia para tu estatura: {kg} kg. El tope de la mochila se calcula sobre él, no sobre tu peso real.',
			'checklist.weight.referenceFallbackHeight' => 'El tope de tu mochila se calcula sobre tu peso real: para tu estatura no existe un peso de referencia publicado en el que apoyarse. Preferimos decírtelo antes que mostrarte una cifra falsa.',
			'checklist.weight.descentAlertTitle' => 'Bajadas: lo que llevas',
			'checklist.weight.descentAlertBody' => 'Dos pesos bajan contigo: {pack} kg de mochila y {above} kg por encima de tu peso de forma. En bajada, cada paso hace pasar por la rodilla 3,46 veces el peso que baja contigo, frente a 2,61 en llano. Solo la mochila se puede cambiar hoy: aligérala, y es menos en cada paso.',
			'checklist.weight.descentAlertBodyPackOnly' => 'Bajas con {pack} kg de mochila. En bajada, cada paso hace pasar por la rodilla 3,46 veces el peso que baja contigo, frente a 2,61 en llano: aligera la mochila, y es menos en cada paso.',
			'checklist.weight.descentStage' => '{stage}: {loss} m de bajada',
			'checklist.ui.title' => 'Equipo & Mochila',
			'checklist.ui.requirementRequired' => 'Obligatorio',
			'checklist.ui.addItem' => 'Añadir un artículo',
			'checklist.ui.addItemTitle' => 'Añadir un artículo',
			'checklist.ui.fieldName' => 'Nombre',
			'checklist.ui.fieldWeightGrams' => 'Peso (gramos)',
			'checklist.ui.errorWeightGrams' => 'Peso no válido (0 a 50 000 g)',
			'checklist.ui.errorNameRequired' => 'Nombre obligatorio',
			'checklist.ui.add' => 'Añadir',
			'checklist.ui.editWeightTitle' => 'Editar el peso',
			'checklist.ui.editCustomTitle' => 'Editar artículo personalizado',
			'checklist.ui.modify' => 'Editar',
			'checklist.ui.delete' => 'Eliminar',
			'checklist.ui.deleteItemTitle' => 'Eliminar este artículo?',
			'checklist.ui.deleteItemBody' => 'El artículo "{name}" se eliminará definitivamente.',
			...
			'checklist.ui.addToShoppingList' => 'Añadir a la lista de la compra',
			...
			'checklist.ui.infoCheckTitle' => 'Marca los artículos',
			...
			'checklist.ui.bagValidatedMissingSnack' => 'Mochila validada (con artículos faltantes)!',
			'checklist.ui.shareGroupHint' => 'Únete a un grupo para compartir tu checklist.',
			'checklist.ui.shareFailed' => 'No se ha podido abrir la función de compartir en este dispositivo.',
			'checklist.seasonalBanner' => ({required Object season}) => 'Mochila adaptada a la temporada (${season}) y a tu sendero.',
			'checklist.seasons.winter' => 'invierno',
			'checklist.seasons.spring' => 'primavera',
			'checklist.seasons.summer' => 'verano',
			'checklist.seasons.autumn' => 'otoño',
			...
			'journal.addPhoto' => 'Añadir una foto',
			'journal.photoAdded' => 'Foto añadida al diario',
			'journal.photoSource' => 'Origen de la foto',
			'journal.camera' => 'Cámara',
			'journal.gallery' => 'Galería',
			'journal.removePhoto' => 'Quitar la foto',
			'journal.photoError' => 'No se ha podido añadir la foto',
			'journal.dayNavPrevious' => 'Día anterior',
			'journal.dayNavNext' => 'Día siguiente',
			'journal.dayOfTrek' => ({required Object day}) => 'Día ${day}',
			...
			'journal.distance' => 'Distancia',
			'journal.elevationGain' => 'Desnivel positivo',
			'journal.elevationLoss' => 'Desnivel negativo',
			'journal.duration' => 'Duración',
			'journal.maxAltitude' => 'Altitud máxima',
			'journal.share' => 'Compartir',
			'journal.shareSubject' => 'Mi diario de senderismo',
			...
			'weather.program.restDay' => 'Descanso',
			'weather.program.place' => ({required Object place}) => 'en ${place}',
			'weather.program.trendBadge' => 'Tendencia',
			'weather.program.trendHint' => ({required Object reliable}) => 'Más allá de ${reliable} días solo es una tendencia: una previsión a 10 días acierta una vez de cada dos.',
			...
			'settings.noDateChosen' => 'Ninguna fecha elegida',
			'settings.departureDate' => 'Fecha de salida',
			...
			'feasibility.formula.hardestStage' => ({required Object stage}) => 'Jornada más exigente: ${stage}',
			...
			'tips.themes.safety' => 'Seguridad',
			'tips.themes.health' => 'Salud',
			'tips.themes.weather' => 'Meteo',
			'tips.themes.refuge' => 'Vida en refugio',
			...
			'training.progress' => ({required Object done, required Object total}) => '${done} de ${total} sesiones hechas',
			...
			'training.freqSourceNotice' => 'Las frecuencias no son cifras de la casa: 3 sesiones de resistencia y 2 de refuerzo por semana, 2 días de descanso, según REI (Conditioning for Backpacking), Terres d\'Aventure y las recomendaciones de la OMS de 2020.',
			...
			'packs.actions.buyUnavailable' => 'La compra no está disponible en este dispositivo.',
			...
			'packs.progress.errorSnack' => 'La descarga no se ha completado.',
			...
			'health.delete.button' => 'Borrar mi ficha',
			'health.delete.a11yButton' => 'Borrar mi ficha de salud — acción definitiva',
			'health.delete.confirmTitle' => '¿Borrar tu ficha de salud?',
			'health.delete.confirmBody' => 'Es definitivo y local. Tu información se eliminará de este teléfono.',
			'health.delete.cancel' => 'Cancelar',
			'health.delete.confirm' => 'Borrar',
			...
			'nuitees.card.eveBadge' => 'D-1',
			'nuitees.card.eveOfDeparture' => 'Víspera de la salida',
			...
			'transport.tabJoin' => 'Llegar a la salida',
			'transport.tabJoinNamed' => ({required Object name}) => 'Llegar a ${name}',
			'transport.tabLeave' => 'Salir de la llegada',
			'transport.tabLeaveNamed' => ({required Object name}) => 'Salir de ${name}',
			'transport.joinTitle' => ({required Object name}) => 'Llegar a ${name}',
			'transport.leaveTitle' => ({required Object name}) => 'Salir de ${name}',
			'transport.adviceTitle' => 'Consejos prácticos',
			'transport.website' => 'Sitio web',
			'transport.a11y.call' => ({required Object label}) => 'Llamar a ${label}',
			'transport.a11y.website' => 'Abrir el sitio web',
			'transport.noneForTrail' => 'No hay información de transporte para este sendero.',
			...
			'fireRisk.refreshNothing' => 'Nada que actualizar por ahora.',
			'fireRisk.refreshPartial' => ({required Object done, required Object total}) => 'Actualización parcial: ${done} etapa(s) de ${total}.',
			'fireRisk.refreshedAt' => ({required Object date}) => 'Datos actualizados (${date})',
			'fireRisk.stagePlace' => ({required Object place}) => 'Llegada: ${place}',
			'shop.title' => 'Avituallamiento',
			'shop.filterAll' => 'Todos',
			'shop.typeEpicerie' => 'Tienda',
			'shop.typeBar' => 'Bar/Restaurante',
			'shop.typePharmacie' => 'Farmacia',
			'shop.typeGaz' => 'Gas/Material',
			'shop.limitedTitle' => 'Puntos de avituallamiento limitados',
			'shop.stageHeader' => ({required Object n}) => 'Etapa ${n}',
			'shop.stageBadge' => ({required Object n}) => 'Etapa ${n}',
			'shop.gapShort' => ({required Object n}) => 'Último avituallamiento antes de ${n} etapas sin comercio',
			'shop.gapLong' => ({required Object n}) => 'Último avituallamiento antes de ${n} etapas sin comercio. ¡Abastécete!',
			'shop.sectionInfo' => 'Información',
			'shop.sectionProducts' => 'Productos disponibles',
			'shop.fieldType' => 'Tipo',
			'shop.fieldStage' => 'Etapa',
			'shop.fieldGps' => 'GPS',
			'shop.fieldHours' => 'Horario',
			...
			'import.statElevationGain' => 'Desnivel +',
			'import.statElevationLoss' => 'Desnivel -',
			'import.statDuration' => 'Duración',
			'import.statDirection' => 'Dirección',
			'import.statPoints' => 'Puntos GPS',
			'import.directionNS' => 'Norte-Sur',
			'import.directionSN' => 'Sur-Norte',
			'import.stagesSection' => 'Etapas detectadas',
			'import.stagesCount' => '{done}/{total}',
			'import.stageBadge' => 'E{number}',
			'import.warningsSection' => 'Advertencias',
			'import.warningOutOfBounds' => '{count} punto(s) fuera de zona ignorados.',
			'import.warningOffTrail' => 'El {percent}% de los puntos está lejos del sendero.',
			'import.invalidTooFewPoints' => 'Archivo GPX insuficiente: {count} puntos (mínimo 10).',
			...
			'hikerProfile.errorAge' => 'Edad no válida (18 a 120 años)',
			'hikerProfile.ageUsage' => 'Para qué sirve tu edad: fija la distancia de referencia de tu prueba de marcha y baja un nivel el asignado a partir de los 60 años, dos a partir de los 75. No sirve para nada más, y nada de eso sale de tu teléfono.',
			'hikerProfile.fieldHeight' => 'Altura',
			'hikerProfile.hintHeight' => 'En centímetros',
			'hikerProfile.errorHeight' => 'Altura no válida (60 a 255 cm)',
			...
			'walkTest.meters' => 'm',
			'walkTest.resultTitle' => 'Resultado de la prueba',
			'walkTest.resultDistance' => 'Distancia recorrida',
			'walkTest.resultLevel' => 'Nivel estimado',
			...
			'walkTest.absoluteScaleNotice' => 'Tu nivel se lee en la escala de distancia bruta: la comparación con una referencia no se estableció para tu constitución, así que no la aplicamos. Tu test sigue siendo perfectamente válido.',
			'walkTest.ageClampNotice' => 'Más allá de los 80 años la referencia del test se detiene: se calcula como a los 80, y te lo decimos.',
			'walkTest.gpsUnavailable' => 'La ubicación no está disponible en este dispositivo: la prueba no puede medir la distancia.',
			...
			'pastHikes.fieldAvgHours' => 'Tiempo de marcha por día (h)',
			...
			'pastHikes.backToFeasibility' => 'Volver a la viabilidad',
			...
			'common.stageNotFound' => 'Etapa no encontrada',
			'common.cannotLoadTrack' => 'No se puede cargar el trazado',
			'common.loadingTrack' => 'Cargando el trazado…',
			'common.gpxEmpty' => 'El archivo GPX no contiene ningún punto.',
			'common.noPoiForStage' => 'Ningún punto de interés para esta etapa.',
			'common.viewOnMap' => 'Ver en el mapa',
			'common.error' => 'Error',
			'common.pageNotFound' => ({required Object path}) => 'Página no encontrada: ${path}',
