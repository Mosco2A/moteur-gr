...
class TranslationsEn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _Translations$myTreks$en myTreks = _Translations$myTreks$en._(_root);
	@override late final _Translations$trekState$en trekState = _Translations$trekState$en._(_root);
	@override late final _Translations$hikerProfile$en hikerProfile = _Translations$hikerProfile$en._(_root);
...
class _Translations$navPilote$en extends Translations$navPilote$fr {
	...
	@override String get startTrek => 'Start the trek';
	@override String get finishTrek => 'Finish the trek';
	@override String get reviewPrep => 'Review preparation';
	@override String get startGateSubtitle => 'Complete Itinerary, Date and Programme to start';
	@override String get startAwayTitle => 'Start the trek';
	@override String startAwayBody({required Object distance}) => 'You don\'t seem to be at the starting point (${distance} m away). Start anyway?';
	@override String get startNoGpsBody => 'Location unavailable. Start anyway?';
	@override String get startConfirm => 'Start anyway';
	@override String get startCancel => 'Cancel';
	...
	@override String get dominantHand => 'Dominant hand';
	@override String get dominantHandDesc => 'Places SOS and key controls on your hand side';
	@override String get dominantHandRight => 'Right-handed';
	@override String get dominantHandLeft => 'Left-handed';
	@override String get weatherBannerTitle => 'Here and now';
	@override String get weatherBannerStages => 'Stage forecast';
	@override String get weatherBannerUnavailable => 'Local weather unavailable';
}
...
class _Translations$hub$en extends Translations$hub$fr {
	...
	@override late final _Translations$hub$finishTrek$en finishTrek = _Translations$hub$finishTrek$en._(_root);
}
...
class _Translations$itinerary$en extends Translations$itinerary$fr {
	...
	@override String stageCount({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('en'))(n,
		one: '${n} stage',
		other: '${n} stages',
	);
...
class _Translations$tracking$en extends Translations$tracking$fr {
	...
	@override String get stopTitle => 'Stop tracking?';
	@override String get stopBody => 'Your progress will be saved.';
	@override String get dMinus => 'D-';
	@override String get avgSpeed => 'Avg speed';
	@override String get altitude => 'Altitude';
...
class _Translations$journal$en extends Translations$journal$fr {
	...
	@override String get photoAdded => 'Photo added to the journal';
...
class _Translations$settings$en extends Translations$settings$fr {
	...
	@override String get noDateChosen => 'No date chosen';
	@override String get departureDate => 'Departure date';
}
...
class _Translations$feasibility$en extends Translations$feasibility$fr {
	...
	@override late final _Translations$feasibility$gaps$en gaps = _Translations$feasibility$gaps$en._(_root);
	@override late final _Translations$feasibility$formula$en formula = _Translations$feasibility$formula$en._(_root);
	@override late final _Translations$feasibility$flow$en flow = _Translations$feasibility$flow$en._(_root);
}
...
class _Translations$onboarding$en extends Translations$onboarding$fr {
	...
	@override String get recoveryNudge => 'Remember to note your recovery code (in settings): it unlocks your data on another phone.';
}
...
class _Translations$training$en extends Translations$training$fr {
	...
	@override String freqPerWeek({required Object n}) => '${n}× per week';
	@override String get freqOncePerPhase => 'once during the phase';
	@override String get freqFinalWeek => 'the final week only';
	@override String get freqSourceNotice => 'The frequencies are not in-house numbers: 3 endurance sessions and 2 strength sessions a week, 2 rest days, after REI (Conditioning for Backpacking), Terres d\'Aventure and the 2020 WHO guidelines.';
...
class _Translations$health$en extends Translations$health$fr {
	...
	@override late final _Translations$health$error$en error = _Translations$health$error$en._(_root);
	@override String get save => 'Save';
...
class _Translations$transport$en extends Translations$transport$fr {
	...
	@override String get noneForTrail => 'No transport information for this trail.';
}
...
// Path: myTreks
class _Translations$myTreks$en extends Translations$myTreks$fr {
	_Translations$myTreks$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get title => 'My treks';
	...
	@override String get accountTitle => 'My account';
	@override String get accountSubtitle => 'Profile and settings';
	@override late final _Translations$myTreks$badge$en badge = _Translations$myTreks$badge$en._(_root);
...
// Path: trekState
class _Translations$trekState$en extends Translations$trekState$fr {
	_Translations$trekState$en._(TranslationsEn root) : this._root = root, super.internal(root);
...
// Path: hikerProfile
class _Translations$hikerProfile$en extends Translations$hikerProfile$fr {
	_Translations$hikerProfile$en._(TranslationsEn root) : this._root = root, super.internal(root);
	...
	@override String get errorAge => 'Invalid age (18 to 120 years)';
	@override String get ageUsage => 'What your age is used for: it sets the reference distance of your walk test, and it lowers the retained level by one notch from 60, by two from 75. It is used for nothing else, and none of it leaves your phone.';
	@override String get fieldHeight => 'Height';
	@override String get hintHeight => 'In centimetres';
	@override String get errorHeight => 'Invalid height (60 to 255 cm)';
	@override String get fieldWeight => 'Weight';
...
// Path: walkTest
class _Translations$walkTest$en extends Translations$walkTest$fr {
	_Translations$walkTest$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get title => '6-minute walk test';
	@override String get intro => 'Walk as far as you can in 6 minutes on flat ground. GPS measures the distance; we compare it to norms for your age and sex.';
	@override String get safetyWarning => 'Avoid this effort if you have an unchecked heart condition. Stop if you feel unwell.';
	@override String get start => 'Start the test';
	@override String get stop => 'Stop';
	@override String get cancel => 'Cancel';
	@override String get countdown => 'Get ready...';
	@override String get running => 'In progress';
	@override String get liveDistance => 'Distance';
	@override String get timeLeft => 'Time left';
	@override String get meters => 'm';
	@override String get resultTitle => 'Test result';
	@override String get resultDistance => 'Distance covered';
	@override String get resultLevel => 'Estimated level';
	@override String resultDate({required Object date}) => 'Taken on ${date}';
	@override String get doneAgain => 'Retake the test';
	@override String get gpsNeeded => 'GPS is required to measure the distance.';
	@override String get gpsDenied => 'Allow location to start the test.';
	@override String get monthlyReminderOn => 'Monthly reminder on';
	@override String get monthlyReminderBody => 'A test reminder will be offered every month to track your fitness.';
	...
	@override String get gpsUnavailable => 'Location is not available on this device: the test cannot measure distance.';
}

// Path: pastHikes
class _Translations$pastHikes$en extends Translations$pastHikes$fr {
	_Translations$pastHikes$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Your last 5 hikes';
	@override String get intro => 'Add up to 5 notable hikes. We deduce your real level (pace, endurance, elevation habit) rather than a label.';
	@override String get addHike => 'Add a hike';
	...
	@override String get errorHours => 'Invalid duration (0 to 24 h)';
	@override String get errorElevation => 'Invalid elevation (0 to 5000 m)';
	@override String get errorDistance => 'Invalid distance (0 to 100 km)';
	@override String get errorEffort => 'Enter at least the elevation gain or the distance';
	@override String get perDay => 'per day';
	@override String get editHike => 'Edit hike';
	@override String get deleteHike => 'Delete';
	@override String get save => 'Save';
	@override String get backToFeasibility => 'Back to feasibility';
	@override String get saved => 'Hikes saved';
	@override String get maxReached => 'Maximum of 5 hikes reached.';
}

// Path: ffrando
class _Translations$ffrando$en extends Translations$ffrando$fr {
	_Translations$ffrando$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get cotationTitle => 'FFRandonnee rating';
	@override String get effort => 'Effort';
	@override String get technicite => 'Technicality';
	@override String get risque => 'Risk';
	@override String get ibpLabel => 'IBP index';
	@override String get effortScale => 'Effort (1 to 5)';
	@override String get techniciteScale => 'Technicality (1 to 5)';
...
class _Translations$sos$en extends Translations$sos$fr {
	...
	@override String cannotCall({required Object number}) => 'This device cannot place the call. Dial ${number}.';
}

// Path: recovery
class _Translations$recovery$en extends Translations$recovery$fr {
	_Translations$recovery$en._(TranslationsEn root) : this._root = root, super.internal(root);
...
// Path: common
class _Translations$common$en extends Translations$common$fr {
	_Translations$common$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get cannotLoadStages => 'Unable to load stages';
	@override String get noStages => 'No stages available';
	@override String get cannotLoadStage => 'Unable to load this stage';
	@override String get stageNotFound => 'Stage not found';
	@override String get cannotLoadTrack => 'Unable to load the track';
	@override String get loadingTrack => 'Loading track…';
	@override String get gpxEmpty => 'The GPX file contains no points.';
	@override String get noPoiForStage => 'No point of interest for this stage.';
	@override String get viewOnMap => 'View on map';
	@override String get error => 'Error';
	@override String pageNotFound({required Object path}) => 'Page not found: ${path}';
...
// Path: hub.finishTrek
class _Translations$hub$finishTrek$en extends Translations$hub$finishTrek$fr {
	_Translations$hub$finishTrek$en._(TranslationsEn root) : this._root = root, super.internal(root);
...
// Path: map.guide
class _Translations$map$guide$en extends Translations$map$guide$fr {
	_Translations$map$guide$en._(TranslationsEn root) : this._root = root, super.internal(root);
...
class _Translations$checklist$ui$en extends Translations$checklist$ui$fr {
	...
	@override String get errorWeightGrams => 'Invalid weight (0 to 50,000 g)';
	@override String get errorNameRequired => 'Name required';
	...
	@override String get shareFailed => 'Sharing could not open on this device.';
}
...
class _Translations$feasibility$gaps$en extends Translations$feasibility$gaps$fr {
	_Translations$feasibility$gaps$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get elevationPerDay => 'Daily elevation gain too high vs your habit';
	@override String get distancePerDay => 'Daily distance above your experience';
	@override String get consecutiveDays => 'More consecutive days than ever done';
	@override String get technicity => 'Terrain technicality above your level';
...
class _Translations$feasibility$formula$en extends Translations$feasibility$formula$fr {
	_Translations$feasibility$formula$en._(TranslationsEn root) : this._root = root, super.internal(root);
	...
	@override String hardestStage({required Object stage}) => 'Toughest day: ${stage}';
	@override String daysOver({required Object count}) => '${count} day(s) above your ceiling';
	@override String get daysOverNone => 'No day above your ceiling';
...
class _Translations$feasibility$flow$en extends Translations$feasibility$flow$fr {
	_Translations$feasibility$flow$en._(TranslationsEn root) : this._root = root, super.internal(root);
...
// Path: health.error
class _Translations$health$error$en extends Translations$health$error$fr {
	_Translations$health$error$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get bloodType => 'Invalid blood type (A+, A-, B+, B-, AB+, AB-, O+, O-)';
}
...
class _Translations$programme$splitBlocked$en extends Translations$programme$splitBlocked$fr {
	_Translations$programme$splitBlocked$en._(TranslationsEn root) : this._root = root, super.internal(root);
...
class _Translations$nuitees$card$en extends Translations$nuitees$card$fr {
	...
	@override String get eveOfDeparture => 'Night before departure';
}
...
// Path: myTreks.badge
class _Translations$myTreks$badge$en extends Translations$myTreks$badge$fr {
	_Translations$myTreks$badge$en._(TranslationsEn root) : this._root = root, super.internal(root);
...
// Path: myTreks.a11y
class _Translations$myTreks$a11y$en extends Translations$myTreks$a11y$fr {
	_Translations$myTreks$a11y$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String trekCard({required Object nom, required Object state}) => 'Trek ${nom}, ${state}';
	@override String openTrek({required Object nom}) => 'Open trek ${nom}';
}

// Path: trekState.abandonDialog
class _Translations$trekState$abandonDialog$en extends Translations$trekState$abandonDialog$fr {
	_Translations$trekState$abandonDialog$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get title => 'A trek is already in progress';
	@override String get message => 'You have an ongoing hike. Finish it or give it up before starting another one.';
...
class _Translations$walkTest$levels$en extends Translations$walkTest$levels$fr {
	_Translations$walkTest$levels$en._(TranslationsEn root) : this._root = root, super.internal(root);
...
class _Translations$ffrando$effortLevels$en extends Translations$ffrando$effortLevels$fr {
	_Translations$ffrando$effortLevels$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get k1 => 'Very easy';
	@override String get k2 => 'Easy';
...
// Path: map.guide.poi
class _Translations$map$guide$poi$en extends Translations$map$guide$poi$fr {
	_Translations$map$guide$poi$en._(TranslationsEn root) : this._root = root, super.internal(root);
...
class _Translations$feasibility$formula$levels$en extends Translations$feasibility$formula$levels$fr {
	_Translations$feasibility$formula$levels$en._(TranslationsEn root) : this._root = root, super.internal(root);
...
class _Translations$feasibility$formula$verdicts$en extends Translations$feasibility$formula$verdicts$fr {
	_Translations$feasibility$formula$verdicts$en._(TranslationsEn root) : this._root = root, super.internal(root);
...
class _Translations$feasibility$formula$limitingFactors$en extends Translations$feasibility$formula$limitingFactors$fr {
	_Translations$feasibility$formula$limitingFactors$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get distance => 'the daily distance';
...
class _Translations$feasibility$formula$advice$en extends Translations$feasibility$formula$advice$fr {
	_Translations$feasibility$formula$advice$en._(TranslationsEn root) : this._root = root, super.internal(root);
...
extension on TranslationsEn {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'navPilote.startTrek' => 'Start the trek',
			'navPilote.finishTrek' => 'Finish the trek',
			'navPilote.reviewPrep' => 'Review preparation',
			'navPilote.startGateSubtitle' => 'Complete Itinerary, Date and Programme to start',
			'navPilote.startAwayTitle' => 'Start the trek',
			'navPilote.startAwayBody' => ({required Object distance}) => 'You don\'t seem to be at the starting point (${distance} m away). Start anyway?',
			'navPilote.startNoGpsBody' => 'Location unavailable. Start anyway?',
			'navPilote.startConfirm' => 'Start anyway',
			'navPilote.startCancel' => 'Cancel',
			...
			'navPilote.dominantHand' => 'Dominant hand',
			'navPilote.dominantHandDesc' => 'Places SOS and key controls on your hand side',
			'navPilote.dominantHandRight' => 'Right-handed',
			'navPilote.dominantHandLeft' => 'Left-handed',
			'navPilote.weatherBannerTitle' => 'Here and now',
			'navPilote.weatherBannerStages' => 'Stage forecast',
			'navPilote.weatherBannerUnavailable' => 'Local weather unavailable',
			...
			'poi.danger' => 'Danger',
			'poi.shop' => 'Shop',
			'poi.accommodation' => 'Accommodation',
			...
			'tracking.stopTitle' => 'Stop tracking?',
			'tracking.stopBody' => 'Your progress will be saved.',
			'tracking.dMinus' => 'D-',
			...
			'checklist.ui.errorWeightGrams' => 'Invalid weight (0 to 50,000 g)',
			'checklist.ui.errorNameRequired' => 'Name required',
			...
			'checklist.ui.shareFailed' => 'Sharing could not open on this device.',
			...
			'journal.photoAdded' => 'Photo added to the journal',
			...
			'settings.noDateChosen' => 'No date chosen',
			'settings.departureDate' => 'Departure date',
			...
			'feasibility.gaps.elevationPerDay' => 'Daily elevation gain too high vs your habit',
			'feasibility.gaps.distancePerDay' => 'Daily distance above your experience',
			'feasibility.gaps.consecutiveDays' => 'More consecutive days than ever done',
			'feasibility.gaps.technicity' => 'Terrain technicality above your level',
			'feasibility.gaps.risk' => 'High risk level for this trek',
			...
			'feasibility.formula.hardestStage' => ({required Object stage}) => 'Toughest day: ${stage}',
			'feasibility.formula.daysOver' => ({required Object count}) => '${count} day(s) above your ceiling',
			'feasibility.formula.daysOverNone' => 'No day above your ceiling',
			...
			'nuitees.card.eveOfDeparture' => 'Night before departure',
			...
			'transport.noneForTrail' => 'No transport information for this trail.',
			...
			'myTreks.accountTitle' => 'My account',
			'myTreks.accountSubtitle' => 'Profile and settings',
			'myTreks.badge.owned' => 'Owned',
			...
			'hikerProfile.errorAge' => 'Invalid age (18 to 120 years)',
			'hikerProfile.ageUsage' => 'What your age is used for: it sets the reference distance of your walk test, and it lowers the retained level by one notch from 60, by two from 75. It is used for nothing else, and none of it leaves your phone.',
			'hikerProfile.fieldHeight' => 'Height',
			'hikerProfile.hintHeight' => 'In centimetres',
			'hikerProfile.errorHeight' => 'Invalid height (60 to 255 cm)',
			...
			'walkTest.countdown' => 'Get ready...',
			'walkTest.running' => 'In progress',
			'walkTest.liveDistance' => 'Distance',
			'walkTest.timeLeft' => 'Time left',
			'walkTest.meters' => 'm',
			'walkTest.resultTitle' => 'Test result',
			'walkTest.resultDistance' => 'Distance covered',
			'walkTest.resultLevel' => 'Estimated level',
			'walkTest.resultDate' => ({required Object date}) => 'Taken on ${date}',
			'walkTest.doneAgain' => 'Retake the test',
			'walkTest.gpsNeeded' => 'GPS is required to measure the distance.',
			...
			'walkTest.gpsUnavailable' => 'Location is not available on this device: the test cannot measure distance.',
			...
			'pastHikes.errorHours' => 'Invalid duration (0 to 24 h)',
			'pastHikes.errorElevation' => 'Invalid elevation (0 to 5000 m)',
			'pastHikes.errorDistance' => 'Invalid distance (0 to 100 km)',
			'pastHikes.errorEffort' => 'Enter at least the elevation gain or the distance',
			'pastHikes.perDay' => 'per day',
			'pastHikes.editHike' => 'Edit hike',
			'pastHikes.deleteHike' => 'Delete',
			'pastHikes.save' => 'Save',
			'pastHikes.backToFeasibility' => 'Back to feasibility',
			'pastHikes.saved' => 'Hikes saved',
			...
			'ffrando.effortScale' => 'Effort (1 to 5)',
			'ffrando.techniciteScale' => 'Technicality (1 to 5)',
			'ffrando.risqueScale' => 'Risk (1 to 5)',
			...
			'sos.cannotCall' => ({required Object number}) => 'This device cannot place the call. Dial ${number}.',
			...
			'common.stageNotFound' => 'Stage not found',
			'common.cannotLoadTrack' => 'Unable to load the track',
			'common.loadingTrack' => 'Loading track…',
			'common.gpxEmpty' => 'The GPX file contains no points.',
			'common.noPoiForStage' => 'No point of interest for this stage.',
			'common.viewOnMap' => 'View on map',
			'common.error' => 'Error',
			'common.pageNotFound' => ({required Object path}) => 'Page not found: ${path}',
