...
class TranslationsIt extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _Translations$myTreks$it myTreks = _Translations$myTreks$it._(_root);
	@override late final _Translations$trekState$it trekState = _Translations$trekState$it._(_root);
	@override late final _Translations$hikerProfile$it hikerProfile = _Translations$hikerProfile$it._(_root);
	@override late final _Translations$walkTest$it walkTest = _Translations$walkTest$it._(_root);
...
class _Translations$nav$it extends Translations$nav$fr {
	...
	@override String get currentStage => 'Tappa attuale';
...
class _Translations$navPilote$it extends Translations$navPilote$fr {
	...
	@override String get startTrek => 'Inizia il trek';
	@override String get finishTrek => 'Termina il trek';
	@override String get reviewPrep => 'Rivedi la preparazione';
	@override String get startGateSubtitle => 'Completa Itinerario, Data e Programma per iniziare';
	@override String get startAwayTitle => 'Inizia il trek';
	@override String startAwayBody({required Object distance}) => 'Non sembri al punto di partenza (a ${distance} m). Iniziare comunque?';
	@override String get startNoGpsBody => 'Posizione non disponibile. Iniziare comunque?';
	@override String get startConfirm => 'Inizia comunque';
	@override String get startCancel => 'Annulla';
	@override String get phasePrepareSub => 'Organizza il tuo trek prima della partenza';
	@override String get phaseHikeSub => 'Il tuo trek è in corso';
	@override String phaseHikeInProgress({required Object trek}) => '${trek} in corso';
	@override String get phaseAfterSub => 'Rivivi la tua avventura';
	@override String get phaseBanner => 'Fase in corso';
	@override String get demoPreview => 'Anteprima fasi (demo): Preparare, Camminare, Dopo';
...
class _Translations$stage$it extends Translations$stage$fr {
	...
	@override String get departureArrival => 'Da {from} a {to}';
...
class _Translations$poi$it extends Translations$poi$fr {
	...
	@override String get accommodation => 'Alloggio';
	@override String get info => 'Informazione';
...
class _Translations$checklist$it extends Translations$checklist$fr {
	...
	@override String seasonalBanner({required Object season}) => 'Zaino adattato alla stagione (${season}) e al tuo sentiero.';
	@override late final _Translations$checklist$seasons$it seasons = _Translations$checklist$seasons$it._(_root);
...
class _Translations$journal$it extends Translations$journal$fr {
	...
	@override String get photoAdded => 'Foto aggiunta al diario';
...
class _Translations$diploma$it extends Translations$diploma$fr {
	...
	@override String finisherNumber({required Object number}) => 'Diploma n. ${number}';
	@override String get shareDiploma => 'Condividi il mio diploma';
	@override String get shareError => 'Condivisione non riuscita';
}
...
class _Translations$tips$it extends Translations$tips$fr {
	...
	@override String get scopeAll => 'Tutti i sentieri';
	...
	@override String get linkOffline => 'Link non disponibile offline';
	@override String get emptyThemed => 'Nessuna scheda consigli per questo sentiero.';
	@override String moreTips({required Object n}) => '+ ${n} consigli';
	@override late final _Translations$tips$themes$it themes = _Translations$tips$themes$it._(_root);
}
...
class _Translations$training$it extends Translations$training$fr {
	...
	@override String progress({required Object done, required Object total}) => '${done} sessioni su ${total} completate';
	...
	@override String phaseWeeks({required Object start, required Object end, required Object title}) => 'Settimane ${start}-${end} · ${title}';
	...
	@override String freqPerWeek({required Object n}) => '${n}× a settimana';
	@override String get freqOncePerPhase => 'una volta nella fase';
	@override String get freqFinalWeek => 'solo l\'ultima settimana';
	@override String get freqSourceNotice => 'Le frequenze non sono numeri inventati in casa: 3 sedute di endurance e 2 di rinforzo a settimana, 2 giorni di riposo, secondo REI (Conditioning for Backpacking), Terres d\'Aventure e le raccomandazioni OMS 2020.';
...
class _Translations$health$it extends Translations$health$fr {
	...
	@override late final _Translations$health$error$it error = _Translations$health$error$it._(_root);
	@override String get save => 'Salva';
...
class _Translations$programme$it extends Translations$programme$fr {
	...
	@override String get validateNext => 'Conferma e scegli le date';
	...
	@override String get reorderBlocked => 'Trek avviato: l\'ordine delle tappe non cambia più';
	@override late final _Translations$programme$inTrek$it inTrek = _Translations$programme$inTrek$it._(_root);
}
...
// Path: transport
class _Translations$transport$it extends Translations$transport$fr {
	_Translations$transport$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Trasporti';
	@override String get tabJoin => 'Raggiungere la partenza';
	@override String tabJoinNamed({required Object name}) => 'Raggiungere ${name}';
	@override String get tabLeave => 'Ripartire dall\'arrivo';
	@override String tabLeaveNamed({required Object name}) => 'Ripartire da ${name}';
	@override String joinTitle({required Object name}) => 'Raggiungere ${name}';
	@override String leaveTitle({required Object name}) => 'Ripartire da ${name}';
...
// Path: fireRisk
class _Translations$fireRisk$it extends Translations$fireRisk$fr {
	_Translations$fireRisk$it._(TranslationsIt root) : this._root = root, super.internal(root);
	...
	@override String get refresh => 'Aggiorna';
	@override String get refreshed => 'Dati aggiornati';
	...
	@override String get stagesTitle => 'Rischio per tappa';
	@override String stageBadge({required Object number}) => 'T${number}';
	@override String levelBadge({required Object level}) => 'Liv. ${level}';
	@override String dayLevel({required Object level}) => 'Liv. ${level}';
	@override late final _Translations$fireRisk$day$it day = _Translations$fireRisk$day$it._(_root);
	@override String get noRisk => 'Nessun rischio incendio attualmente segnalato';
	@override String get numbersTitle => 'Numeri utili';
...
class _Translations$summary$it extends Translations$summary$fr {
	...
	// Translations
	@override String get title => 'Sintesi del piano';
	@override String configTitle({required Object name}) => 'Il mio ${name}';
	@override String get direction => 'Direzione';
	@override String get duration => 'Durata';
	@override String durationValue({required Object days}) => '${days} giorni di cammino';
	@override String durationValueWithRest({required Object days, required Object rest}) => '${days} giorni di cammino + ${rest} riposo';
	@override String get startDate => 'Partenza';
	@override String get endDate => 'Arrivo';
	@override late final _Translations$summary$stats$it stats = _Translations$summary$stats$it._(_root);
	@override String get dayByDay => 'Giorno per giorno';
	@override String dayLabel({required Object n}) => 'G${n}';
	@override String stageLabel({required Object n}) => 'Tappa ${n}';
	@override String get restDay => 'Giorno di riposo';
	@override String restDayTitle({required Object n}) => 'Giorno di riposo — G${n}';
	@override String restDayPlace({required Object place}) => 'Luogo: ${place}';
	@override late final _Translations$summary$actions$it actions = _Translations$summary$actions$it._(_root);
	@override late final _Translations$summary$share$it share = _Translations$summary$share$it._(_root);
	@override late final _Translations$summary$empty$it empty = _Translations$summary$empty$it._(_root);
...
// Path: myTreks
class _Translations$myTreks$it extends Translations$myTreks$fr {
	_Translations$myTreks$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get title => 'I miei trek';
	...
	@override String get accountTitle => 'Il mio account';
	@override String get accountSubtitle => 'Profilo e impostazioni';
...
// Path: trekState
class _Translations$trekState$it extends Translations$trekState$fr {
	_Translations$trekState$it._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: hikerProfile
class _Translations$hikerProfile$it extends Translations$hikerProfile$fr {
	_Translations$hikerProfile$it._(TranslationsIt root) : this._root = root, super.internal(root);
	...
	@override String get errorAge => 'Età non valida (18 a 120 anni)';
	@override String get ageUsage => 'A cosa serve la tua età: fissa la distanza di riferimento del tuo test del cammino e abbassa di un livello quello assegnato dai 60 anni, di due dai 75. Non serve a nient\'altro, e niente esce dal tuo telefono.';
	@override String get fieldHeight => 'Altezza';
	@override String get hintHeight => 'In centimetri';
	@override String get errorHeight => 'Altezza non valida (60 a 255 cm)';
...
// Path: walkTest
class _Translations$walkTest$it extends Translations$walkTest$fr {
	_Translations$walkTest$it._(TranslationsIt root) : this._root = root, super.internal(root);
	...
	@override String get stop => 'Ferma';
	@override String get cancel => 'Annulla';
	@override String get countdown => 'Preparati...';
	@override String get running => 'In corso';
	@override String get liveDistance => 'Distanza';
	@override String get timeLeft => 'Tempo rimanente';
	@override String get meters => 'm';
	@override String get resultTitle => 'Risultato del test';
	@override String get resultDistance => 'Distanza percorsa';
...
// Path: pastHikes
class _Translations$pastHikes$it extends Translations$pastHikes$fr {
	_Translations$pastHikes$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Le tue ultime 5 escursioni';
	@override String get intro => 'Aggiungi fino a 5 escursioni notevoli. Deduciamo il tuo livello reale (ritmo, resistenza, abitudine al dislivello) invece di un\'etichetta.';
	@override String get addHike => 'Aggiungi escursione';
	...
	@override String get errorHours => 'Durata non valida (0 a 24 h)';
	@override String get errorElevation => 'Dislivello non valido (0 a 5000 m)';
	@override String get errorDistance => 'Distanza non valida (0 a 100 km)';
	@override String get errorEffort => 'Indica almeno il dislivello o la distanza';
	@override String get perDay => 'al giorno';
	@override String get editHike => 'Modifica escursione';
	@override String get deleteHike => 'Elimina';
	@override String get save => 'Salva';
	@override String get backToFeasibility => 'Torna alla fattibilità';
	@override String get saved => 'Escursioni salvate';
	@override String get maxReached => 'Massimo di 5 escursioni raggiunto.';
}

// Path: ffrando
class _Translations$ffrando$it extends Translations$ffrando$fr {
	_Translations$ffrando$it._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: sos
class _Translations$sos$it extends Translations$sos$fr {
	_Translations$sos$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Chiamare i soccorsi?';
	...
	@override String get cancel => 'Annulla';
	@override String get call => 'Chiama 112';
...
class _Translations$hub$cards$it extends Translations$hub$cards$fr {
	...
	@override String get transportSub => 'Andata e ritorno';
...
// Path: map.guide
class _Translations$map$guide$it extends Translations$map$guide$fr {
	_Translations$map$guide$it._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _Translations$tracking$backgroundRationale$it extends Translations$tracking$backgroundRationale$fr {
	_Translations$tracking$backgroundRationale$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Registrare la tua traccia anche a schermo spento';
	@override String get body => 'Durante l\'escursione StepWays registra la tua traccia senza interruzioni, anche con il telefono in tasca. Android ti chiederà di consentire la posizione « Sempre »: serve solo a questo, e soltanto durante un\'escursione in corso.';
...
class _Translations$checklist$items$it extends Translations$checklist$items$fr {
	...
	@override String get seasonalMicrospikes => 'Ramponcini leggeri (microspikes)';
	@override String get seasonalWarmGloves => 'Guanti caldi';
	@override String get seasonalThermalBase => 'Strato termico base';
	@override String get seasonalExtraWater => 'Acqua supplementare';
	@override String get seasonalSunHat => 'Cappello da sole';
	@override String get seasonalElectrolytesPlus => 'Elettroliti (caldo)';
	@override String get seasonalGaitersMud => 'Ghette (fango primaverile)';
	@override String get seasonalHeadlampSpare => 'Lampada frontale di scorta (giorni corti)';
	@override String get seasonalMamExtraWater => 'Scorta d\'acqua rinforzata (zone aride)';
}
...
class _Translations$checklist$weight$it extends Translations$checklist$weight$fr {
	...
	@override String get recommended => 'Peso consigliato';
...
class _Translations$checklist$ui$it extends Translations$checklist$ui$fr {
	...
	@override String get errorWeightGrams => 'Peso non valido (0 a 50 000 g)';
	@override String get errorNameRequired => 'Nome obbligatorio';
...
class _Translations$checklist$seasons$it extends Translations$checklist$seasons$fr {
	_Translations$checklist$seasons$it._(TranslationsIt root) : this._root = root, super.internal(root);
	...
	@override String get autumn => 'autunno';
}
...
class _Translations$feasibility$gaps$it extends Translations$feasibility$gaps$fr {
	_Translations$feasibility$gaps$it._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _Translations$feasibility$formula$it extends Translations$feasibility$formula$fr {
	_Translations$feasibility$formula$it._(TranslationsIt root) : this._root = root, super.internal(root);
	...
	@override String hardestStage({required Object stage}) => 'Giornata più impegnativa: ${stage}';
	@override String daysOver({required Object count}) => '${count} giorno/i oltre la tua soglia';
	@override String get daysOverNone => 'Nessun giorno oltre la tua soglia';
...
// Path: tips.seasons
class _Translations$tips$seasons$it extends Translations$tips$seasons$fr {
	_Translations$tips$seasons$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get all => 'Tutto l\'anno';
	@override String get winter => 'Inverno';
	@override String get spring => 'Primavera';
	@override String get summer => 'Estate';
	@override String get autumn => 'Autunno';
...
// Path: tips.themes
class _Translations$tips$themes$it extends Translations$tips$themes$fr {
	_Translations$tips$themes$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get gear => 'Attrezzatura';
	@override String get safety => 'Sicurezza';
	@override String get health => 'Salute';
	@override String get weather => 'Meteo';
	@override String get refuge => 'Vita in rifugio';
	@override String get nature => 'Natura';
	@override String get other => 'Varie';
}
...
// Path: health.error
class _Translations$health$error$it extends Translations$health$error$fr {
	_Translations$health$error$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get bloodType => 'Gruppo sanguigno non valido (A+, A-, B+, B-, AB+, AB-, O+, O-)';
}
...
// Path: health.delete
class _Translations$health$delete$it extends Translations$health$delete$fr {
	_Translations$health$delete$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get button => 'Elimina la mia scheda';
	@override String get a11yButton => 'Elimina la mia scheda sanitaria — azione definitiva';
	@override String get confirmTitle => 'Eliminare la scheda sanitaria?';
	@override String get confirmBody => 'È definitivo e locale. Le tue informazioni saranno rimosse da questo telefono.';
	@override String get cancel => 'Annulla';
	@override String get confirm => 'Elimina';
	@override String get done => 'Scheda sanitaria eliminata.';
}

// Path: health.consent
class _Translations$health$consent$it extends Translations$health$consent$fr {
	_Translations$health$consent$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get purpose => 'Queste info servono a soccorrerti. Restano sul tuo telefono, mai inviate su internet.';
	@override String get manage => 'Gestisci il mio consenso sanitario';
}

// Path: health.advice
class _Translations$health$advice$it extends Translations$health$advice$fr {
	_Translations$health$advice$it._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _Translations$programme$inTrek$it extends Translations$programme$inTrek$fr {
	_Translations$programme$inTrek$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Adattare l\'itinerario';
	@override String get intro => 'Riorganizza il seguito del tuo trek. Ciò che hai già percorso è bloccato e l\'ordine delle tappe non cambia.';
	@override String get doneSection => 'Già percorso';
	@override String get upcomingSection => 'A venire';
	@override String get doneBadge => 'Fatto';
	@override String get lockedDay => 'Giorno già percorso, bloccato';
	@override String get allDone => 'Hai percorso tutti i tuoi giorni: non c\'è più nulla da adattare.';
	@override String get notStarted => 'Questa schermata serve in cammino: avvia il trek per adattare il seguito.';
	@override String get validate => 'Salvare le modifiche';
	@override String get saved => 'Programma aggiornato';
	@override late final _Translations$programme$inTrek$info$it info = _Translations$programme$inTrek$info$it._(_root);
	@override late final _Translations$programme$inTrek$empty$it empty = _Translations$programme$inTrek$empty$it._(_root);
}
...
class _Translations$nuitees$card$it extends Translations$nuitees$card$fr {
	...
	@override String get eveBadge => 'G-1';
	@override String get eveOfDeparture => 'Notte prima della partenza';
}
...
// Path: transport.a11y
class _Translations$transport$a11y$it extends Translations$transport$a11y$fr {
	_Translations$transport$a11y$it._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _Translations$fireRisk$update$it extends Translations$fireRisk$update$fr {
	...
	// Translations
	@override String get live => 'Dati aggiornati';
	@override String liveAt({required Object date}) => 'Agg.: ${date}';
	@override String cacheRecent({required Object duration}) => 'Aggiornato ${duration} fa';
	@override String cacheOld({required Object date}) => 'Ultimo agg.: ${date}';
	@override String get never => 'Mai aggiornato';
}

// Path: fireRisk.duration
class _Translations$fireRisk$duration$it extends Translations$fireRisk$duration$fr {
	_Translations$fireRisk$duration$it._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _Translations$fireRisk$regulation$it extends Translations$fireRisk$regulation$fr {
	_Translations$fireRisk$regulation$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Normativa';
	@override String get decreeLink => 'Consulta le ordinanze prefettizie';
}

// Path: fireRisk.level
class _Translations$fireRisk$level$it extends Translations$fireRisk$level$fr {
	_Translations$fireRisk$level$it._(TranslationsIt root) : this._root = root, super.internal(root);
	...
	@override String get moderate => 'Moderato';
	@override String get high => 'Elevato';
	@override String get veryHigh => 'Molto elevato';
	@override String get extreme => 'Estremo';
}

// Path: fireRisk.day
class _Translations$fireRisk$day$it extends Translations$fireRisk$day$fr {
	_Translations$fireRisk$day$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get today => 'Oggi';
	@override String get tomorrow => 'Dom.';
	@override String plus({required Object n}) => 'G+${n}';
}

// Path: fireRisk.number
class _Translations$fireRisk$number$it extends Translations$fireRisk$number$fr {
	_Translations$fireRisk$number$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get firefighters => 'Vigili del fuoco';
	@override String get europeanEmergency => 'Emergenza europea';
}

// Path: fireRisk.empty
class _Translations$fireRisk$empty$it extends Translations$fireRisk$empty$fr {
	_Translations$fireRisk$empty$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Rischio incendio non disponibile';
	@override String get message => 'I dati meteo necessari per calcolare il rischio incendio non sono disponibili al momento. Riprova una volta connesso.';
}

// Path: fireRisk.a11y
class _Translations$fireRisk$a11y$it extends Translations$fireRisk$a11y$fr {
	_Translations$fireRisk$a11y$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String call({required Object label, required Object number}) => 'Chiama ${label} al ${number}';
	@override String get decree => 'Apri le ordinanze prefettizie';
	@override String levelBadge({required Object level}) => 'Livello di rischio ${level} su 5';
}
...
class _Translations$summary$stats$it extends Translations$summary$stats$fr {
	...
	@override String get distance => 'Distanza totale';
	@override String get elevationGain => 'Dislivello positivo';
	@override String get elevationLoss => 'Dislivello negativo';
	@override String get duration => 'Tempo stimato';
	@override String get stages => 'Tappe';
	@override String get restDays => 'Giorni di riposo';
}

// Path: summary.actions
class _Translations$summary$actions$it extends Translations$summary$actions$fr {
	_Translations$summary$actions$it._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: summary.share
class _Translations$summary$share$it extends Translations$summary$share$fr {
	_Translations$summary$share$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String titleLine({required Object name}) => 'Il mio ${name}';
	@override String walkDays({required Object days}) => '${days} giorni di cammino';
	@override String walkDaysWithRest({required Object days, required Object rest}) => '${days} giorni di cammino + ${rest} giorni di riposo';
	@override String distance({required Object km}) => 'Distanza: ${km} km';
	@override String elevationGain({required Object m}) => 'Dislivello positivo: ${m} m';
	@override String elevationLoss({required Object m}) => 'Dislivello negativo: ${m} m';
	@override String duration({required Object h}) => 'Tempo stimato: ~${h} h';
	@override String dates({required Object start, required Object end}) => 'Dal ${start} al ${end}';
	@override String get planning => '--- Programma giorno per giorno ---';
	@override String dayRest({required Object n}) => 'G${n}: Riposo';
	@override String dayStages({required Object n, required Object stages}) => 'G${n}: ${stages}';
	@override String footer({required Object name}) => 'Pianificato con ${name}';
}

// Path: summary.empty
class _Translations$summary$empty$it extends Translations$summary$empty$fr {
	_Translations$summary$empty$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Configura prima il tuo itinerario';
	@override String get message => 'Scegli il percorso e la durata per vedere la sintesi del tuo piano.';
	@override String get action => 'CONFIGURA L\'ITINERARIO';
}

// Path: summary.a11y
class _Translations$summary$a11y$it extends Translations$summary$a11y$fr {
	_Translations$summary$a11y$it._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: myTreks.badge
class _Translations$myTreks$badge$it extends Translations$myTreks$badge$fr {
	_Translations$myTreks$badge$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get owned => 'Posseduto';
	@override String get prepared => 'Preparato';
	@override String get inProgress => 'In corso';
	@override String get completed => 'Completato';
}

// Path: myTreks.a11y
class _Translations$myTreks$a11y$it extends Translations$myTreks$a11y$fr {
	_Translations$myTreks$a11y$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String trekCard({required Object nom, required Object state}) => 'Trek ${nom}, ${state}';
	@override String openTrek({required Object nom}) => 'Apri il trek ${nom}';
}

// Path: trekState.abandonDialog
class _Translations$trekState$abandonDialog$it extends Translations$trekState$abandonDialog$fr {
	_Translations$trekState$abandonDialog$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Un trek è già in corso';
	@override String get message => 'Hai un\'escursione in corso. Terminala o abbandonala prima di iniziarne un\'altra.';
...
class _Translations$walkTest$levels$it extends Translations$walkTest$levels$fr {
	...
	@override String get good => 'Buono';
	@override String get excellent => 'Eccellente';
}

// Path: ffrando.effortLevels
class _Translations$ffrando$effortLevels$it extends Translations$ffrando$effortLevels$fr {
	_Translations$ffrando$effortLevels$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get k1 => 'Molto facile';
	@override String get k2 => 'Facile';
	@override String get k3 => 'Medio';
	@override String get k4 => 'Difficile';
	@override String get k5 => 'Molto difficile';
}

// Path: sos.medicalId
class _Translations$sos$medicalId$it extends Translations$sos$medicalId$fr {
	_Translations$sos$medicalId$it._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: map.guide.poi
class _Translations$map$guide$poi$it extends Translations$map$guide$poi$fr {
	_Translations$map$guide$poi$it._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _Translations$feasibility$formula$levels$it extends Translations$feasibility$formula$levels$fr {
	_Translations$feasibility$formula$levels$it._(TranslationsIt root) : this._root = root, super.internal(root);
	...
	@override String get confirmed => 'esperto';
	@override String get expert => 'avanzato';
}

// Path: feasibility.formula.verdicts
class _Translations$feasibility$formula$verdicts$it extends Translations$feasibility$formula$verdicts$fr {
	_Translations$feasibility$formula$verdicts$it._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _Translations$feasibility$formula$limitingFactors$it extends Translations$feasibility$formula$limitingFactors$fr {
	_Translations$feasibility$formula$limitingFactors$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get distance => 'la distanza giornaliera';
...
class _Translations$feasibility$formula$advice$it extends Translations$feasibility$formula$advice$fr {
	_Translations$feasibility$formula$advice$it._(TranslationsIt root) : this._root = root, super.internal(root);
	...
	@override String optimalDays({required Object days, required Object current}) => 'Punta a ${days} giorni di cammino (invece di ${current}) per restare sotto la soglia.';
	@override String split({required Object stage}) => 'Dividi la giornata ${stage} in due: supera nettamente la tua soglia.';
	@override String splitImpossible({required Object stage}) => 'La giornata ${stage} resta oltre le tue capacità anche divisa in due, e non si può dividere più corta: non è più una questione di programma. Allenati, aspetta condizioni più miti o scegli un sentiero meno impegnativo.';
	...
	@override String restAdvised({required Object days, required Object stages}) => 'Inserisci ${days} giorno/i di riposo, dopo le giornate ${stages}: si somigliano troppo perché il corpo recuperi. È un consiglio, non cambia il tuo verdetto.';
}
...
class _Translations$programme$inTrek$info$it extends Translations$programme$inTrek$info$fr {
	_Translations$programme$inTrek$info$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Adattare l\'itinerario';
	@override late final _Translations$programme$inTrek$info$done$it done = _Translations$programme$inTrek$info$done$it._(_root);
	@override late final _Translations$programme$inTrek$info$upcoming$it upcoming = _Translations$programme$inTrek$info$upcoming$it._(_root);
	@override late final _Translations$programme$inTrek$info$order$it order = _Translations$programme$inTrek$info$order$it._(_root);
	@override String get close => 'Capito';
}

// Path: programme.inTrek.empty
class _Translations$programme$inTrek$empty$it extends Translations$programme$inTrek$empty$fr {
	_Translations$programme$inTrek$empty$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Nessun programma da adattare';
	@override String get message => 'Crea prima il tuo programma nella preparazione.';
}

// Path: programme.inTrek.info.done
class _Translations$programme$inTrek$info$done$it extends Translations$programme$inTrek$info$done$fr {
	_Translations$programme$inTrek$info$done$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Giorni già percorsi';
	@override String get body => 'Sono in grigio e bloccati: ciò che è fatto è fatto.';
}

// Path: programme.inTrek.info.upcoming
class _Translations$programme$inTrek$info$upcoming$it extends Translations$programme$inTrek$info$upcoming$fr {
	_Translations$programme$inTrek$info$upcoming$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Giorni a venire';
	@override String get body => 'Raggruppa, separa o aggiungi un giorno di riposo nel seguito del percorso.';
}

// Path: programme.inTrek.info.order
class _Translations$programme$inTrek$info$order$it extends Translations$programme$inTrek$info$order$fr {
	_Translations$programme$inTrek$info$order$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Ordine delle tappe';
	@override String get body => 'L\'ordine non cambia mai una volta partiti: le tappe già avviate non si invertono.';
}
...
extension on TranslationsIt {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'nav.map' => 'Mappa',
			'nav.stages' => 'Tappe',
			'nav.currentStage' => 'Tappa attuale',
			...
			'navPilote.startTrek' => 'Inizia il trek',
			'navPilote.finishTrek' => 'Termina il trek',
			'navPilote.reviewPrep' => 'Rivedi la preparazione',
			'navPilote.startGateSubtitle' => 'Completa Itinerario, Data e Programma per iniziare',
			'navPilote.startAwayTitle' => 'Inizia il trek',
			'navPilote.startAwayBody' => ({required Object distance}) => 'Non sembri al punto di partenza (a ${distance} m). Iniziare comunque?',
			'navPilote.startNoGpsBody' => 'Posizione non disponibile. Iniziare comunque?',
			'navPilote.startConfirm' => 'Inizia comunque',
			'navPilote.startCancel' => 'Annulla',
			'navPilote.phasePrepareSub' => 'Organizza il tuo trek prima della partenza',
			'navPilote.phaseHikeSub' => 'Il tuo trek è in corso',
			'navPilote.phaseHikeInProgress' => ({required Object trek}) => '${trek} in corso',
			'navPilote.phaseAfterSub' => 'Rivivi la tua avventura',
			'navPilote.phaseBanner' => 'Fase in corso',
			'navPilote.demoPreview' => 'Anteprima fasi (demo): Preparare, Camminare, Dopo',
			...
			'hub.cards.transport' => 'Trasporti',
			'hub.cards.transportSub' => 'Andata e ritorno',
			...
			'stage.departureArrival' => 'Da {from} a {to}',
			...
			'poi.danger' => 'Pericolo',
			'poi.shop' => 'Negozio',
			'poi.accommodation' => 'Alloggio',
			'poi.info' => 'Informazione',
			...
			'checklist.items.seasonalMicrospikes' => 'Ramponcini leggeri (microspikes)',
			'checklist.items.seasonalWarmGloves' => 'Guanti caldi',
			'checklist.items.seasonalThermalBase' => 'Strato termico base',
			'checklist.items.seasonalExtraWater' => 'Acqua supplementare',
			'checklist.items.seasonalSunHat' => 'Cappello da sole',
			'checklist.items.seasonalElectrolytesPlus' => 'Elettroliti (caldo)',
			'checklist.items.seasonalGaitersMud' => 'Ghette (fango primaverile)',
			'checklist.items.seasonalHeadlampSpare' => 'Lampada frontale di scorta (giorni corti)',
			'checklist.items.seasonalMamExtraWater' => 'Scorta d\'acqua rinforzata (zone aride)',
			'checklist.essential' => 'Essenziale',
			'checklist.weight.title' => 'Peso dello zaino',
			'checklist.weight.recommended' => 'Peso consigliato',
			...
			'checklist.ui.errorWeightGrams' => 'Peso non valido (0 a 50 000 g)',
			'checklist.ui.errorNameRequired' => 'Nome obbligatorio',
			...
			'checklist.seasonalBanner' => ({required Object season}) => 'Zaino adattato alla stagione (${season}) e al tuo sentiero.',
			'checklist.seasons.winter' => 'inverno',
			'checklist.seasons.spring' => 'primavera',
			'checklist.seasons.summer' => 'estate',
			'checklist.seasons.autumn' => 'autunno',
			...
			'journal.photoAdded' => 'Foto aggiunta al diario',
			...
			'diploma.finisherNumber' => ({required Object number}) => 'Diploma n. ${number}',
			'diploma.shareDiploma' => 'Condividi il mio diploma',
			'diploma.shareError' => 'Condivisione non riuscita',
			...
			'feasibility.formula.hardestStage' => ({required Object stage}) => 'Giornata più impegnativa: ${stage}',
			'feasibility.formula.daysOver' => ({required Object count}) => '${count} giorno/i oltre la tua soglia',
			'feasibility.formula.daysOverNone' => 'Nessun giorno oltre la tua soglia',
			...
			'feasibility.formula.advice.split' => ({required Object stage}) => 'Dividi la giornata ${stage} in due: supera nettamente la tua soglia.',
			'feasibility.formula.advice.splitImpossible' => ({required Object stage}) => 'La giornata ${stage} resta oltre le tue capacità anche divisa in due, e non si può dividere più corta: non è più una questione di programma. Allenati, aspetta condizioni più miti o scegli un sentiero meno impegnativo.',
			...
			'feasibility.formula.advice.restAdvised' => ({required Object days, required Object stages}) => 'Inserisci ${days} giorno/i di riposo, dopo le giornate ${stages}: si somigliano troppo perché il corpo recuperi. È un consiglio, non cambia il tuo verdetto.',
			...
			'tips.scopeAll' => 'Tutti i sentieri',
			'tips.seasons.all' => 'Tutto l\'anno',
			'tips.seasons.winter' => 'Inverno',
			'tips.seasons.spring' => 'Primavera',
			'tips.seasons.summer' => 'Estate',
			...
			'tips.linkOffline' => 'Link non disponibile offline',
			'tips.emptyThemed' => 'Nessuna scheda consigli per questo sentiero.',
			'tips.moreTips' => ({required Object n}) => '+ ${n} consigli',
			'tips.themes.gear' => 'Attrezzatura',
			'tips.themes.safety' => 'Sicurezza',
			'tips.themes.health' => 'Salute',
			'tips.themes.weather' => 'Meteo',
			'tips.themes.refuge' => 'Vita in rifugio',
			...
			'training.progress' => ({required Object done, required Object total}) => '${done} sessioni su ${total} completate',
			...
			'training.freqSourceNotice' => 'Le frequenze non sono numeri inventati in casa: 3 sedute di endurance e 2 di rinforzo a settimana, 2 giorni di riposo, secondo REI (Conditioning for Backpacking), Terres d\'Aventure e le raccomandazioni OMS 2020.',
			...
			'health.delete.button' => 'Elimina la mia scheda',
			'health.delete.a11yButton' => 'Elimina la mia scheda sanitaria — azione definitiva',
			'health.delete.confirmTitle' => 'Eliminare la scheda sanitaria?',
			'health.delete.confirmBody' => 'È definitivo e locale. Le tue informazioni saranno rimosse da questo telefono.',
			'health.delete.cancel' => 'Annulla',
			'health.delete.confirm' => 'Elimina',
			'health.delete.done' => 'Scheda sanitaria eliminata.',
			'health.consent.purpose' => 'Queste info servono a soccorrerti. Restano sul tuo telefono, mai inviate su internet.',
			...
			'programme.inTrek.intro' => 'Riorganizza il seguito del tuo trek. Ciò che hai già percorso è bloccato e l\'ordine delle tappe non cambia.',
			...
			'programme.inTrek.info.title' => 'Adattare l\'itinerario',
			'programme.inTrek.info.done.title' => 'Giorni già percorsi',
			'programme.inTrek.info.done.body' => 'Sono in grigio e bloccati: ciò che è fatto è fatto.',
			'programme.inTrek.info.upcoming.title' => 'Giorni a venire',
			'programme.inTrek.info.upcoming.body' => 'Raggruppa, separa o aggiungi un giorno di riposo nel seguito del percorso.',
			'programme.inTrek.info.order.title' => 'Ordine delle tappe',
			'programme.inTrek.info.order.body' => 'L\'ordine non cambia mai una volta partiti: le tappe già avviate non si invertono.',
			'programme.inTrek.info.close' => 'Capito',
			'programme.inTrek.empty.title' => 'Nessun programma da adattare',
			'programme.inTrek.empty.message' => 'Crea prima il tuo programma nella preparazione.',
			...
			'nuitees.card.eveBadge' => 'G-1',
			'nuitees.card.eveOfDeparture' => 'Notte prima della partenza',
			...
			'transport.tabJoin' => 'Raggiungere la partenza',
			'transport.tabJoinNamed' => ({required Object name}) => 'Raggiungere ${name}',
			'transport.tabLeave' => 'Ripartire dall\'arrivo',
			'transport.tabLeaveNamed' => ({required Object name}) => 'Ripartire da ${name}',
			'transport.joinTitle' => ({required Object name}) => 'Raggiungere ${name}',
			'transport.leaveTitle' => ({required Object name}) => 'Ripartire da ${name}',
			'transport.adviceTitle' => 'Consigli pratici',
			...
			'fireRisk.refreshError' => 'Nessuna connessione',
			'fireRisk.update.live' => 'Dati aggiornati',
			'fireRisk.update.liveAt' => ({required Object date}) => 'Agg.: ${date}',
			'fireRisk.update.cacheRecent' => ({required Object duration}) => 'Aggiornato ${duration} fa',
			'fireRisk.update.cacheOld' => ({required Object date}) => 'Ultimo agg.: ${date}',
			'fireRisk.update.never' => 'Mai aggiornato',
			'fireRisk.duration.seconds' => 'pochi secondi',
			...
			'fireRisk.day.today' => 'Oggi',
			'fireRisk.day.tomorrow' => 'Dom.',
			'fireRisk.day.plus' => ({required Object n}) => 'G+${n}',
			'fireRisk.noRisk' => 'Nessun rischio incendio attualmente segnalato',
			'fireRisk.numbersTitle' => 'Numeri utili',
			'fireRisk.number.firefighters' => 'Vigili del fuoco',
			'fireRisk.number.europeanEmergency' => 'Emergenza europea',
			'fireRisk.empty.title' => 'Rischio incendio non disponibile',
			...
			'summary.durationValueWithRest' => ({required Object days, required Object rest}) => '${days} giorni di cammino + ${rest} riposo',
			'summary.startDate' => 'Partenza',
			'summary.endDate' => 'Arrivo',
			'summary.stats.title' => 'Statistiche',
			'summary.stats.distance' => 'Distanza totale',
			...
			'summary.share.walkDaysWithRest' => ({required Object days, required Object rest}) => '${days} giorni di cammino + ${rest} giorni di riposo',
			'summary.share.distance' => ({required Object km}) => 'Distanza: ${km} km',
			...
			'summary.empty.message' => 'Scegli il percorso e la durata per vedere la sintesi del tuo piano.',
			...
			'myTreks.accountTitle' => 'Il mio account',
			'myTreks.accountSubtitle' => 'Profilo e impostazioni',
			'myTreks.badge.owned' => 'Posseduto',
			...
			'hikerProfile.errorAge' => 'Età non valida (18 a 120 anni)',
			'hikerProfile.ageUsage' => 'A cosa serve la tua età: fissa la distanza di riferimento del tuo test del cammino e abbassa di un livello quello assegnato dai 60 anni, di due dai 75. Non serve a nient\'altro, e niente esce dal tuo telefono.',
			'hikerProfile.fieldHeight' => 'Altezza',
			'hikerProfile.hintHeight' => 'In centimetri',
			'hikerProfile.errorHeight' => 'Altezza non valida (60 a 255 cm)',
			...
			'walkTest.countdown' => 'Preparati...',
			'walkTest.running' => 'In corso',
			'walkTest.liveDistance' => 'Distanza',
			'walkTest.timeLeft' => 'Tempo rimanente',
			'walkTest.meters' => 'm',
			'walkTest.resultTitle' => 'Risultato del test',
			'walkTest.resultDistance' => 'Distanza percorsa',
			...
			'pastHikes.errorHours' => 'Durata non valida (0 a 24 h)',
			'pastHikes.errorElevation' => 'Dislivello non valido (0 a 5000 m)',
			'pastHikes.errorDistance' => 'Distanza non valida (0 a 100 km)',
			'pastHikes.errorEffort' => 'Indica almeno il dislivello o la distanza',
			'pastHikes.perDay' => 'al giorno',
			'pastHikes.editHike' => 'Modifica escursione',
			'pastHikes.deleteHike' => 'Elimina',
			'pastHikes.save' => 'Salva',
			'pastHikes.backToFeasibility' => 'Torna alla fattibilità',
