...
class Translations with BaseTranslations<AppLocale, Translations> {
	...
	late final Translations$navPilote$fr navPilote = Translations$navPilote$fr.internal(_root);
...
// Path: navPilote
class Translations$navPilote$fr {
	Translations$navPilote$fr.internal(this._root);
	...
	String get weatherBannerTitle => 'Ici et maintenant';

	/// fr: 'Météo des étapes'
	String get weatherBannerStages => 'Météo des étapes';

	/// fr: 'Météo localisée indisponible'
	String get weatherBannerUnavailable => 'Météo localisée indisponible';
}
...
class Translations$hub$fr {
	...
	late final Translations$hub$finishTrek$fr finishTrek = Translations$hub$finishTrek$fr.internal(_root);
}
...
class Translations$tracking$fr {
	...
	/// fr: 'Arrêter le suivi ?'
	String get stopTitle => 'Arrêter le suivi ?';

	/// fr: 'La progression sera sauvegardée.'
	String get stopBody => 'La progression sera sauvegardée.';

	/// fr: 'D-'
	String get dMinus => 'D-';

	/// fr: 'Vit. moy.'
	String get avgSpeed => 'Vit. moy.';
...
class Translations$diploma$fr {
	...
	/// fr: 'Diplôme n° $number'
	String finisherNumber({required Object number}) => 'Diplôme n° ${number}';

	/// fr: 'Partager mon diplôme'
	String get shareDiploma => 'Partager mon diplôme';
...
class Translations$feasibility$fr {
	...
	late final Translations$feasibility$flow$fr flow = Translations$feasibility$flow$fr.internal(_root);
}
...
class Translations$tips$fr {
	...
	/// fr: 'Instagram'
	String get viewOnInstagram => 'Instagram';

	/// fr: 'Lien indisponible hors-ligne'
	String get linkOffline => 'Lien indisponible hors-ligne';

	/// fr: 'Aucune fiche conseil disponible pour ce sentier.'
	String get emptyThemed => 'Aucune fiche conseil disponible pour ce sentier.';

	/// fr: '+ $n conseils'
	String moreTips({required Object n}) => '+ ${n} conseils';

	late final Translations$tips$themes$fr themes = Translations$tips$themes$fr.internal(_root);
}
...
class Translations$training$fr {
	...
	/// fr: 'une fois dans la phase'
	String get freqOncePerPhase => 'une fois dans la phase';

	/// fr: 'la dernière semaine seulement'
	String get freqFinalWeek => 'la dernière semaine seulement';
...
class Translations$programme$fr {
	...
	/// fr: 'Rando démarrée : l'ordre des étapes ne change plus'
	String get reorderBlocked => 'Rando démarrée : l\'ordre des étapes ne change plus';

	late final Translations$programme$inTrek$fr inTrek = Translations$programme$inTrek$fr.internal(_root);
}
...
class Translations$walkTest$fr {
	...
	/// fr: 'Ton niveau est lu sur l'échelle de distance brute : la comparaison à une référence n'a pas été établie pour ta morphologie, on ne l'applique donc pas. Ton test, lui, reste parfaitement valable.'
	String get absoluteScaleNotice => 'Ton niveau est lu sur l\'échelle de distance brute : la comparaison à une référence n\'a pas été établie pour ta morphologie, on ne l\'applique donc pas. Ton test, lui, reste parfaitement valable.';
...
class Translations$pastHikes$fr {
	...
	/// fr: 'Revenir à la faisabilité'
	String get backToFeasibility => 'Revenir à la faisabilité';
...
// Path: recovery
class Translations$recovery$fr {
	Translations$recovery$fr.internal(this._root);

	final Translations _root; // ignore: unused_field

	// Translations

	/// fr: 'Compte et reconnexion'
	String get section => 'Compte et reconnexion';

	/// fr: 'Voir mon code de reconnexion'
	String get sectionDesc => 'Voir mon code de reconnexion';
...
class Translations$common$fr {
	Translations$common$fr.internal(this._root);

	final Translations _root; // ignore: unused_field

	// Translations

	/// fr: 'Impossible de charger les étapes'
	String get cannotLoadStages => 'Impossible de charger les étapes';

	/// fr: 'Aucune étape disponible'
	String get noStages => 'Aucune étape disponible';

	/// fr: 'Impossible de charger cette étape'
	String get cannotLoadStage => 'Impossible de charger cette étape';

	/// fr: 'Étape introuvable'
	String get stageNotFound => 'Étape introuvable';

	/// fr: 'Impossible de charger le tracé'
	String get cannotLoadTrack => 'Impossible de charger le tracé';

	/// fr: 'Chargement du tracé…'
	String get loadingTrack => 'Chargement du tracé…';

	/// fr: 'Le fichier GPX ne contient aucun point.'
	String get gpxEmpty => 'Le fichier GPX ne contient aucun point.';

	/// fr: 'Aucun point d'intérêt pour cette étape.'
	String get noPoiForStage => 'Aucun point d\'intérêt pour cette étape.';
...
// Path: hub.finishTrek
class Translations$hub$finishTrek$fr {
	Translations$hub$finishTrek$fr.internal(this._root);
	...
	/// fr: 'Terminer le trek'
	String get action => 'Terminer le trek';
...
class Translations$tracking$backgroundRationale$fr {
	Translations$tracking$backgroundRationale$fr.internal(this._root);

	final Translations _root; // ignore: unused_field

	// Translations

	/// fr: 'Suivre ta trace même écran éteint'
	String get title => 'Suivre ta trace même écran éteint';

	/// fr: 'Pendant la randonnée, StepWays enregistre ta trace en continu, y compris téléphone en poche. Android va te demander d'autoriser la localisation « Toujours » : c'est uniquement pour ça, et seulement pendant une rando en cours.'
	String get body => 'Pendant la randonnée, StepWays enregistre ta trace en continu, y compris téléphone en poche. Android va te demander d\'autoriser la localisation « Toujours » : c\'est uniquement pour ça, et seulement pendant une rando en cours.';

	/// fr: 'Si tu refuses, la randonnée démarre quand même : la trace est enregistrée tant que l'application reste à l'écran.'
	String get ifRefused => 'Si tu refuses, la randonnée démarre quand même : la trace est enregistrée tant que l\'application reste à l\'écran.';
...
class Translations$checklist$weight$fr {
	...
	/// fr: '{pct}% du poids de référence'
	String get percentOfReference => '{pct}% du poids de référence';

	/// fr: 'Objectif max : < 15% en refuge, < 20% en autonomie — du poids de référence'
	String get gaugeObjectiveReference => 'Objectif max : < 15% en refuge, < 20% en autonomie — du poids de référence';

	/// fr: 'Poids de référence pour ta taille : {kg} kg. Le plafond du sac est calculé sur lui, pas sur ton poids réel.'
	String get referenceExplainer => 'Poids de référence pour ta taille : {kg} kg. Le plafond du sac est calculé sur lui, pas sur ton poids réel.';
...
class Translations$feasibility$formula$fr {
	Translations$feasibility$formula$fr.internal(this._root);
	...
	/// fr: 'Aucune journée au-dessus de ton plafond'
	String get daysOverNone => 'Aucune journée au-dessus de ton plafond';

	/// fr: 'Facteur limitant : ${factor}'
	String limitingLabel({required Object factor}) => 'Facteur limitant : ${factor}';

	/// fr: 'Entraînement conseillé : ${weeks} semaines avant le départ'
	String trainingReco({required Object weeks}) => 'Entraînement conseillé : ${weeks} semaines avant le départ';
...
class Translations$feasibility$flow$fr {
	Translations$feasibility$flow$fr.internal(this._root);
	...
	/// fr: 'Ta fiche d'info'
	String get stepProfile => 'Ta fiche d\'info';

	/// fr: 'Âge, taille, poids (reste sur ton téléphone).'
	String get stepProfileSub => 'Âge, taille, poids (reste sur ton téléphone).';
	...
	/// fr: 'Ce que tu as déjà tenu : rythme, distance, dénivelé.'
	String get stepPastHikesSub => 'Ce que tu as déjà tenu : rythme, distance, dénivelé.';

	/// fr: '(optionnel)'
	String get optionalTag => '(optionnel)';
...
// Path: health.advice
class Translations$health$advice$fr {
	Translations$health$advice$fr.internal(this._root);

	final Translations _root; // ignore: unused_field

	// Translations

	/// fr: 'Conseils d'usage sur le sentier'
	String get title => 'Conseils d\'usage sur le sentier';
	...
	/// fr: 'Garde une copie papier dans une poche de ton sac : un papier ne tombe jamais en panne de batterie, ne casse pas dans une chute et se lit sous la pluie.'
	String get paper => 'Garde une copie papier dans une poche de ton sac : un papier ne tombe jamais en panne de batterie, ne casse pas dans une chute et se lit sous la pluie.';

	/// fr: 'J'ai lu ces conseils'
	String get ackButton => 'J\'ai lu ces conseils';
...
class Translations$programme$inTrek$fr {
	Translations$programme$inTrek$fr.internal(this._root);
	...
	/// fr: 'Programme mis à jour'
	String get saved => 'Programme mis à jour';

	late final Translations$programme$inTrek$info$fr info = Translations$programme$inTrek$info$fr.internal(_root);
	late final Translations$programme$inTrek$empty$fr empty = Translations$programme$inTrek$empty$fr.internal(_root);
}
...
class Translations$feasibility$formula$verdicts$fr {
	Translations$feasibility$formula$verdicts$fr.internal(this._root);
...
class Translations$feasibility$formula$limitingFactors$fr {
	Translations$feasibility$formula$limitingFactors$fr.internal(this._root);
	...
	/// fr: 'l'enchaînement des journées'
	String get chaining => 'l\'enchaînement des journées';

	/// fr: 'aucun'
	String get none => 'aucun';

	/// fr: 'l'altitude'
	String get altitude => 'l\'altitude';

	/// fr: 'la chaleur de la saison'
	String get heat => 'la chaleur de la saison';
}

// Path: feasibility.formula.advice
class Translations$feasibility$formula$advice$fr {
	Translations$feasibility$formula$advice$fr.internal(this._root);
...
class Translations$programme$inTrek$info$fr {
	Translations$programme$inTrek$info$fr.internal(this._root);
	...
	late final Translations$programme$inTrek$info$done$fr done = Translations$programme$inTrek$info$done$fr.internal(_root);
	late final Translations$programme$inTrek$info$upcoming$fr upcoming = Translations$programme$inTrek$info$upcoming$fr.internal(_root);
	late final Translations$programme$inTrek$info$order$fr order = Translations$programme$inTrek$info$order$fr.internal(_root);
...
class Translations$programme$inTrek$empty$fr {
	Translations$programme$inTrek$empty$fr.internal(this._root);
...
class Translations$programme$inTrek$info$done$fr {
	Translations$programme$inTrek$info$done$fr.internal(this._root);

	final Translations _root; // ignore: unused_field

	// Translations

	/// fr: 'Jours déjà marchés'
	String get title => 'Jours déjà marchés';

	/// fr: 'Ils sont grisés et verrouillés : ce qui est fait est fait.'
	String get body => 'Ils sont grisés et verrouillés : ce qui est fait est fait.';
}

// Path: programme.inTrek.info.upcoming
class Translations$programme$inTrek$info$upcoming$fr {
	Translations$programme$inTrek$info$upcoming$fr.internal(this._root);
...
class Translations$programme$inTrek$info$order$fr {
	Translations$programme$inTrek$info$order$fr.internal(this._root);
	...
	/// fr: 'Ordre des étapes'
	String get title => 'Ordre des étapes';

	/// fr: 'L'ordre ne change jamais une fois parti : on n'inverse pas des étapes déjà engagées.'
	String get body => 'L\'ordre ne change jamais une fois parti : on n\'inverse pas des étapes déjà engagées.';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'checklist.weight.percentOfReference' => '{pct}% du poids de référence',
			...
			'diploma.finisherNumber' => ({required Object number}) => 'Diplôme n° ${number}',
			'diploma.shareDiploma' => 'Partager mon diplôme',
			'diploma.shareError' => 'Partage impossible',
			...
			'settings.departureDate' => 'Date de départ',
			...
			'pastHikes.backToFeasibility' => 'Revenir à la faisabilité',
			...
			'common.stageNotFound' => 'Étape introuvable',
			'common.cannotLoadTrack' => 'Impossible de charger le tracé',
			'common.loadingTrack' => 'Chargement du tracé…',
			'common.gpxEmpty' => 'Le fichier GPX ne contient aucun point.',
			'common.noPoiForStage' => 'Aucun point d\'intérêt pour cette étape.',
