...
mixin _$DayPlan {
  ...
  $DayPlanCopyWith<DayPlan> get copyWith =>
      _$DayPlanCopyWithImpl<DayPlan>(this as DayPlan, _$identity);
...
abstract mixin class $DayPlanCopyWith<$Res> {
  factory $DayPlanCopyWith(DayPlan value, $Res Function(DayPlan) _then) =
      _$DayPlanCopyWithImpl;
  @useResult
  $Res call(
      {int dayNumber,
...
/// @nodoc
class _$DayPlanCopyWithImpl<$Res> implements $DayPlanCopyWith<$Res> {
...
extension DayPlanPatterns on DayPlan {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_DayPlan value)? $default, {
    ...
    switch (_that) {
      case _DayPlan() when $default != null:
        return $default(
            ...
            _that.totalElevationGainM,
            _that.estimatedDurationHours,
            _that.isRestDay);
      case _:
        return orElse();
    }
...
class _DayPlan extends DayPlan {
  const _DayPlan(
      ...
      : _stages = stages,
        super._();
  factory _DayPlan.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$DayPlanCopyWith<_DayPlan> get copyWith =>
      __$DayPlanCopyWithImpl<_DayPlan>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$DayPlanToJson(
      this,
    );
  }
...
abstract mixin class _$DayPlanCopyWith<$Res> implements $DayPlanCopyWith<$Res> {
  factory _$DayPlanCopyWith(_DayPlan value, $Res Function(_DayPlan) _then) =
      __$DayPlanCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int dayNumber,
...
/// @nodoc
class __$DayPlanCopyWithImpl<$Res> implements _$DayPlanCopyWith<$Res> {
