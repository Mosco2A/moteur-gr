...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,titleFr,titleEn,titleDe,titleIt,titleEs,contentFr,contentEn,contentDe,contentIt,contentEs,scope,season,category,theme,urlFacebook,urlInstagram,const DeepCollectionEquality().hash(tags),minAltitudeM,imageAsset,priority]);
...
@useResult
$Res call({
 String id, String titleFr, String titleEn, String titleDe, String titleIt, String titleEs, String contentFr, String contentEn, String contentDe, String contentIt, String contentEs, String scope, String season, String category, String theme, String? urlFacebook, String? urlInstagram, List<String> tags, int? minAltitudeM, String? imageAsset, int priority
});
...
class _TipCard extends TipCard {
  const _TipCard({required this.id, required this.titleFr, this.titleEn = '', this.titleDe = '', this.titleIt = '', this.titleEs = '', required this.contentFr, this.contentEn = '', this.contentDe = '', this.contentIt = '', this.contentEs = '', this.scope = 'all', this.season = 'all', this.category = 'general', this.theme = '', this.urlFacebook, this.urlInstagram, final  List<String> tags = const [], this.minAltitudeM, this.imageAsset, this.priority = 0}): _tags = tags,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,titleFr,titleEn,titleDe,titleIt,titleEs,contentFr,contentEn,contentDe,contentIt,contentEs,scope,season,category,theme,urlFacebook,urlInstagram,const DeepCollectionEquality().hash(_tags),minAltitudeM,imageAsset,priority]);
