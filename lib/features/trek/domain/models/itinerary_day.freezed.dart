...
/// Numero du jour (1-indexed)
 int get dayNumber;/// Liste des etapes prevues ce jour
 List<StageModel> get stages;/// Distance totale en km pour ce jour
 double get totalDistance;/// Denivele positif total en metres pour ce jour
 int get totalElevation;/// Duree estimee en heures
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,dayNumber,const DeepCollectionEquality().hash(stages),totalDistance,totalElevation,estimatedHours);
...
@useResult
$Res call({
 int dayNumber, List<StageModel> stages, double totalDistance, int totalElevation, double estimatedHours
});
...
/// Create a copy of ItineraryDay
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? dayNumber = null,Object? stages = null,Object? totalDistance = null,Object? totalElevation = null,Object? estimatedHours = null,}) {
...
as List<StageModel>,totalDistance: null == totalDistance ? _self.totalDistance : totalDistance // ignore: cast_nullable_to_non_nullable
as double,totalElevation: null == totalElevation ? _self.totalElevation : totalElevation // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int dayNumber,  List<StageModel> stages,  double totalDistance,  int totalElevation,  double estimatedHours)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ItineraryDay() when $default != null:
return $default(_that.dayNumber,_that.stages,_that.totalDistance,_that.totalElevation,_that.estimatedHours);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int dayNumber,  List<StageModel> stages,  double totalDistance,  int totalElevation,  double estimatedHours)  $default,) {final _that = this;
switch (_that) {
case _ItineraryDay():
return $default(_that.dayNumber,_that.stages,_that.totalDistance,_that.totalElevation,_that.estimatedHours);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int dayNumber,  List<StageModel> stages,  double totalDistance,  int totalElevation,  double estimatedHours)?  $default,) {final _that = this;
switch (_that) {
case _ItineraryDay() when $default != null:
return $default(_that.dayNumber,_that.stages,_that.totalDistance,_that.totalElevation,_that.estimatedHours);case _:
  return null;
...
class _ItineraryDay extends ItineraryDay {
  const _ItineraryDay({required this.dayNumber, required final  List<StageModel> stages, required this.totalDistance, required this.totalElevation, required this.estimatedHours}): _stages = stages,super._();
...
@override final  int totalElevation;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,dayNumber,const DeepCollectionEquality().hash(_stages),totalDistance,totalElevation,estimatedHours);
...
/// Create a copy of ItineraryDay
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? dayNumber = null,Object? stages = null,Object? totalDistance = null,Object? totalElevation = null,Object? estimatedHours = null,}) {
