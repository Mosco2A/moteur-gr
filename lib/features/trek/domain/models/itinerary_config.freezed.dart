...
/// Distance maximale par jour en km
 ...
 double get maxHoursPerDay;/// Date de depart prevue
 DateTime get startDate;/// Niveau de difficulte (String extensible, ex: easy, moderate, hard)
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,maxKmPerDay,maxHoursPerDay,startDate,difficultyLevel);
...
@useResult
$Res call({
 double maxKmPerDay, double maxHoursPerDay, DateTime startDate, String difficultyLevel
});
...
/// Create a copy of ItineraryConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? maxKmPerDay = null,Object? maxHoursPerDay = null,Object? startDate = null,Object? difficultyLevel = null,}) {
  return _then(_self.copyWith(
maxKmPerDay: null == maxKmPerDay ? _self.maxKmPerDay : maxKmPerDay // ignore: cast_nullable_to_non_nullable
...
as DateTime,difficultyLevel: null == difficultyLevel ? _self.difficultyLevel : difficultyLevel // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double maxKmPerDay,  double maxHoursPerDay,  DateTime startDate,  String difficultyLevel)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ItineraryConfig() when $default != null:
return $default(_that.maxKmPerDay,_that.maxHoursPerDay,_that.startDate,_that.difficultyLevel);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double maxKmPerDay,  double maxHoursPerDay,  DateTime startDate,  String difficultyLevel)  $default,) {final _that = this;
switch (_that) {
case _ItineraryConfig():
return $default(_that.maxKmPerDay,_that.maxHoursPerDay,_that.startDate,_that.difficultyLevel);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double maxKmPerDay,  double maxHoursPerDay,  DateTime startDate,  String difficultyLevel)?  $default,) {final _that = this;
switch (_that) {
case _ItineraryConfig() when $default != null:
return $default(_that.maxKmPerDay,_that.maxHoursPerDay,_that.startDate,_that.difficultyLevel);case _:
  return null;
...
class _ItineraryConfig extends ItineraryConfig {
  const _ItineraryConfig({required this.maxKmPerDay, required this.maxHoursPerDay, required this.startDate, required this.difficultyLevel}): super._();
...
/// Create a copy of ItineraryConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? maxKmPerDay = null,Object? maxHoursPerDay = null,Object? startDate = null,Object? difficultyLevel = null,}) {
