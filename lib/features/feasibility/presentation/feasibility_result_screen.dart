...
class _RecommendationCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // SW-SKIN-L3e : Card -> AppCard. Fond teinte + liseré de la couleur de
    // NIVEAU (semantique faisabilite) portes par backgroundColor/borderColor ;
    // padding interne repris tel quel (iso-rendu de la carte recommandation).
    return AppCard(
