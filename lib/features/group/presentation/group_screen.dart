...
class _GroupScreenState extends ConsumerState<GroupScreen> {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Partagez votre position avec votre groupe de randonnee.',
            style: theme.textTheme.bodyMedium?.copyWith(
              color: AppTheme.grisTexteSecondaire,
            ),
          ),
          const SizedBox(height: AppTheme.spacingXl),
          // SW-SKIN-L3e : ElevatedButton.icon -> AppButton primary. isLoading
          // porte l'etat de chargement (AppButton affiche son propre spinner et
        ...
        children: [
                ...
                IconButton(
                  ...
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(
                      context,
                    ).showSnackBar(const SnackBar(content: Text('Code copie')));
                  },
                ),
              ],
            ),
          ...
          if (watcherCount >= 2)
            Container(
              ...
              child: Text(
                'Limite de 2 mateurs gratuits atteinte',
                style: theme.textTheme.bodySmall?.copyWith(
                ...
                children: members
                    .map(
                      (m) => Padding(
                        ...
                        child: MemberPositionCard(member: m),
                      ),
                    )
                    .toList(),
              );
  ...
  Future<void> _joinGroup() async {
    ...
    final service = ref.read(groupTrackingServiceProvider);
    final joined = await service.joinGroup(
      code,
      uid: user.uid,
