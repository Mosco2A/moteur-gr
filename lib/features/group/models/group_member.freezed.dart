...
mixin _$GroupMember {
 ...
 String get uid; String? get displayName; double get lastLat; double get lastLng; String get lastUpdate; String? get currentStageId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uid,displayName,lastLat,lastLng,lastUpdate,currentStageId);
...
@useResult
$Res call({
 String uid, String? displayName, double lastLat, double lastLng, String lastUpdate, String? currentStageId
});
...
/// Create a copy of GroupMember
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uid = null,Object? displayName = freezed,Object? lastLat = null,Object? lastLng = null,Object? lastUpdate = null,Object? currentStageId = freezed,}) {
...
as double,lastLng: null == lastLng ? _self.lastLng : lastLng // ignore: cast_nullable_to_non_nullable
as double,lastUpdate: null == lastUpdate ? _self.lastUpdate : lastUpdate // ignore: cast_nullable_to_non_nullable
as String,currentStageId: freezed == currentStageId ? _self.currentStageId : currentStageId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String uid,  String? displayName,  double lastLat,  double lastLng,  String lastUpdate,  String? currentStageId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GroupMember() when $default != null:
return $default(_that.uid,_that.displayName,_that.lastLat,_that.lastLng,_that.lastUpdate,_that.currentStageId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String uid,  String? displayName,  double lastLat,  double lastLng,  String lastUpdate,  String? currentStageId)  $default,) {final _that = this;
switch (_that) {
case _GroupMember():
return $default(_that.uid,_that.displayName,_that.lastLat,_that.lastLng,_that.lastUpdate,_that.currentStageId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String uid,  String? displayName,  double lastLat,  double lastLng,  String lastUpdate,  String? currentStageId)?  $default,) {final _that = this;
switch (_that) {
case _GroupMember() when $default != null:
return $default(_that.uid,_that.displayName,_that.lastLat,_that.lastLng,_that.lastUpdate,_that.currentStageId);case _:
  return null;
...
class _GroupMember implements GroupMember {
  const _GroupMember({required this.uid, this.displayName, required this.lastLat, required this.lastLng, required this.lastUpdate, this.currentStageId});
...
@override final  String? currentStageId;
...
/// Create a copy of GroupMember
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uid = null,Object? displayName = freezed,Object? lastLat = null,Object? lastLng = null,Object? lastUpdate = null,Object? currentStageId = freezed,}) {
...
mixin _$GroupInfo {
 ...
 String get groupCode; String get trailId; String get createdBy; List<GroupMember> get members; int get maxFreeWatchers;
...
@useResult
$Res call({
 String groupCode, String trailId, String createdBy, List<GroupMember> members, int maxFreeWatchers
});
...
/// Create a copy of GroupInfo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? groupCode = null,Object? trailId = null,Object? createdBy = null,Object? members = null,Object? maxFreeWatchers = null,}) {
  return _then(_self.copyWith(
...
as List<GroupMember>,maxFreeWatchers: null == maxFreeWatchers ? _self.maxFreeWatchers : maxFreeWatchers // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String groupCode,  String trailId,  String createdBy,  List<GroupMember> members,  int maxFreeWatchers)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GroupInfo() when $default != null:
return $default(_that.groupCode,_that.trailId,_that.createdBy,_that.members,_that.maxFreeWatchers);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String groupCode,  String trailId,  String createdBy,  List<GroupMember> members,  int maxFreeWatchers)  $default,) {final _that = this;
switch (_that) {
case _GroupInfo():
return $default(_that.groupCode,_that.trailId,_that.createdBy,_that.members,_that.maxFreeWatchers);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String groupCode,  String trailId,  String createdBy,  List<GroupMember> members,  int maxFreeWatchers)?  $default,) {final _that = this;
switch (_that) {
case _GroupInfo() when $default != null:
return $default(_that.groupCode,_that.trailId,_that.createdBy,_that.members,_that.maxFreeWatchers);case _:
  return null;
...
class _GroupInfo implements GroupInfo {
  const _GroupInfo({required this.groupCode, required this.trailId, required this.createdBy, required final  List<GroupMember> members, this.maxFreeWatchers = 2}): _members = members;
...
@override@JsonKey() final  int maxFreeWatchers;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GroupInfo&&(identical(other.groupCode, groupCode) || other.groupCode == groupCode)&&(identical(other.trailId, trailId) || other.trailId == trailId)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&const DeepCollectionEquality().equals(other._members, _members)&&(identical(other.maxFreeWatchers, maxFreeWatchers) || other.maxFreeWatchers == maxFreeWatchers));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,groupCode,trailId,createdBy,const DeepCollectionEquality().hash(_members),maxFreeWatchers);
...
/// Create a copy of GroupInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? groupCode = null,Object? trailId = null,Object? createdBy = null,Object? members = null,Object? maxFreeWatchers = null,}) {
